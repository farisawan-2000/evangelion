...
/* 32F18 800C8318 24A5FFFF */  addiu      $a1, $a1, -0x1
/* 32F1C 800C831C 04A1FFFD */  bgez       $a1, .L800C8314
/* 32F20 800C8320 2442FFFF */   addiu     $v0, $v0, -0x1
...
/* 32F3C 800C833C 24160001 */  addiu      $s6, $zero, 0x1
/* 32F40 800C8340 327000FF */  andi       $s0, $s3, 0xFF
.L800C8344:
/* 32F44 800C8344 16000002 */  bnez       $s0, .L800C8350
/* 32F48 800C8348 24110001 */   addiu     $s1, $zero, 0x1
...
/* 32F6C 800C836C 38820003 */  xori       $v0, $a0, 0x3
...
/* 32F8C 800C838C 32020007 */   andi      $v0, $s0, 0x7
...
.L800C83A0:
/* 32FA0 800C83A0 94C40000 */  lhu        $a0, 0x0($a2)
...
/* 32FB4 800C83B4 24A50001 */   addiu     $a1, $a1, 0x1
...
/* 32FCC 800C83CC 30630007 */  andi       $v1, $v1, 0x7
...
/* 32FF0 800C83F0 24C60002 */   addiu     $a2, $a2, 0x2
.L800C83F4:
/* 32FF4 800C83F4 92430064 */  lbu        $v1, 0x64($s2)
/* 32FF8 800C83F8 26730001 */  addiu      $s3, $s3, 0x1
...
.size func_800C82E0, . - func_800C82E0
