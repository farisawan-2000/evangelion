...
/* 2C958 800C1D58 0C0319D0 */  jal        __osDisableInt
/* 2C95C 800C1D5C AFB00010 */   sw        $s0, 0x10($sp)
/* 2C960 800C1D60 3C03800F */  lui        $v1, %hi(__osRunningThread)
/* 2C964 800C1D64 8C6369C0 */  lw         $v1, %lo(__osRunningThread)($v1)
/* 2C968 800C1D68 3C04800F */  lui        $a0, %hi(__osRunQueue)
/* 2C96C 800C1D6C 248469B8 */  addiu      $a0, $a0, %lo(__osRunQueue)
/* 2C970 800C1D70 24050002 */  addiu      $a1, $zero, 0x2
/* 2C974 800C1D74 00408021 */  addu       $s0, $v0, $zero
/* 2C978 800C1D78 0C031913 */  jal        __osEnqueueAndYield
/* 2C97C 800C1D7C A4650010 */   sh        $a1, 0x10($v1)
/* 2C980 800C1D80 0C0319EC */  jal        __osRestoreInt
...
.size func_800C1D50, . - func_800C1D50
