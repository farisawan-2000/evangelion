...
/* 2EC98 800C4098 AE320004 */  sw         $s2, 0x4($s1)
/* 2EC9C 800C409C AE330008 */  sw         $s3, 0x8($s1)
/* 2ECA0 800C40A0 0C031092 */  jal        func_800C4248
/* 2ECA4 800C40A4 AE200000 */   sw        $zero, 0x0($s1)
...
/* 2ECC4 800C40C4 24060001 */   addiu     $a2, $zero, 0x1
/* 2ECC8 800C40C8 8E240004 */  lw         $a0, 0x4($s1)
/* 2ECCC 800C40CC 8E250008 */  lw         $a1, 0x8($s1)
...
/* 2ED28 800C4128 8E230000 */  lw         $v1, 0x0($s1)
/* 2ED2C 800C412C 34630004 */  ori        $v1, $v1, 0x4
/* 2ED30 800C4130 0803108B */  j          .L800C422C
/* 2ED34 800C4134 AE230000 */   sw        $v1, 0x0($s1)
.L800C4138:
/* 2ED38 800C4138 96420018 */  lhu        $v0, 0x18($s2)
/* 2ED3C 800C413C 30420001 */  andi       $v0, $v0, 0x1
...
/* 2ED70 800C4170 8E220000 */  lw         $v0, 0x0($s1)
/* 2ED74 800C4174 34420004 */  ori        $v0, $v0, 0x4
/* 2ED78 800C4178 0803108A */  j          .L800C4228
/* 2ED7C 800C417C AE220000 */   sw        $v0, 0x0($s1)
.L800C4180:
/* 2ED80 800C4180 97A20048 */  lhu        $v0, 0x48($sp)
/* 2ED84 800C4184 30420001 */  andi       $v0, $v0, 0x1
...
/* 2EDA4 800C41A4 8E240004 */  lw         $a0, 0x4($s1)
/* 2EDA8 800C41A8 8E250008 */  lw         $a1, 0x8($s1)
/* 2EDAC 800C41AC 9242001B */  lbu        $v0, 0x1B($s2)
/* 2EDB0 800C41B0 24060007 */  addiu      $a2, $zero, 0x7
...
/* 2EDC8 800C41C8 24020008 */  addiu      $v0, $zero, 0x8
...
/* 2EDDC 800C41DC 24630003 */  addiu      $v1, $v1, 0x3
/* 2EDE0 800C41E0 AE230060 */  sw         $v1, 0x60($s1)
/* 2EDE4 800C41E4 92230064 */  lbu        $v1, 0x64($s1)
/* 2EDE8 800C41E8 24420001 */  addiu      $v0, $v0, 0x1
...
/* 2EE18 800C4218 8E230000 */  lw         $v1, 0x0($s1)
/* 2EE1C 800C421C 34630001 */  ori        $v1, $v1, 0x1
/* 2EE20 800C4220 0803108B */  j          .L800C422C
/* 2EE24 800C4224 AE230000 */   sw        $v1, 0x0($s1)
.L800C4228:
...
.size func_800C4050, . - func_800C4050
