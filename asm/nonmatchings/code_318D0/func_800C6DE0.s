...
.L800C6E1C:
/* 31A1C 800C6E1C 80A20000 */  lb         $v0, 0x0($a1)
/* 31A20 800C6E20 90B10000 */  lbu        $s1, 0x0($a1)
/* 31A24 800C6E24 08031B8D */  j          .L800C6E34
/* 31A28 800C6E28 00A09021 */   addu      $s2, $a1, $zero
.L800C6E2C:
/* 31A2C 800C6E2C 82420000 */  lb         $v0, 0x0($s2)
/* 31A30 800C6E30 92510000 */  lbu        $s1, 0x0($s2)
.L800C6E34:
...
/* 31A44 800C6E44 5460FFF9 */  bnel       $v1, $zero, .L800C6E2C
/* 31A48 800C6E48 26520001 */   addiu     $s2, $s2, 0x1
...
/* 31A7C 800C6E7C 26520001 */   addiu     $s2, $s2, 0x1
...
.L800C6E8C:
/* 31A8C 800C6E8C 82450000 */  lb         $a1, 0x0($s2)
...
/* 31AAC 800C6EAC 8C420000 */  lw         $v0, 0x0($v0)
/* 31AB0 800C6EB0 26520001 */  addiu      $s2, $s2, 0x1
/* 31AB4 800C6EB4 00621825 */  or         $v1, $v1, $v0
/* 31AB8 800C6EB8 08031BA3 */  j          .L800C6E8C
/* 31ABC 800C6EBC AFA30040 */   sw        $v1, 0x40($sp)
.L800C6EC0:
/* 31AC0 800C6EC0 82430000 */  lb         $v1, 0x0($s2)
...
/* 31AD4 800C6ED4 2403FFFC */  addiu      $v1, $zero, -0x4
/* 31AD8 800C6ED8 24420003 */  addiu      $v0, $v0, 0x3
/* 31ADC 800C6EDC 00431024 */  and        $v0, $v0, $v1
/* 31AE0 800C6EE0 24430004 */  addiu      $v1, $v0, 0x4
/* 31AE4 800C6EE4 AFA300BC */  sw         $v1, 0xBC($sp)
/* 31AE8 800C6EE8 8C420000 */  lw         $v0, 0x0($v0)
...
/* 31B00 800C6F00 34630004 */  ori        $v1, $v1, 0x4
/* 31B04 800C6F04 AFA30040 */  sw         $v1, 0x40($sp)
.L800C6F08:
/* 31B08 800C6F08 08031BDA */  j          .L800C6F68
/* 31B0C 800C6F0C 26520001 */   addiu     $s2, $s2, 0x1
.L800C6F10:
...
/* 31B30 800C6F30 26520001 */   addiu     $s2, $s2, 0x1
/* 31B34 800C6F34 00041080 */  sll        $v0, $a0, 2
/* 31B38 800C6F38 82430000 */  lb         $v1, 0x0($s2)
...
/* 31B50 800C6F50 26520001 */  addiu      $s2, $s2, 0x1
.L800C6F54:
/* 31B54 800C6F54 92420000 */  lbu        $v0, 0x0($s2)
...
/* 31B98 800C6F98 2402FFFC */  addiu      $v0, $zero, -0x4
/* 31B9C 800C6F9C 24630003 */  addiu      $v1, $v1, 0x3
/* 31BA0 800C6FA0 00621824 */  and        $v1, $v1, $v0
/* 31BA4 800C6FA4 24620004 */  addiu      $v0, $v1, 0x4
/* 31BA8 800C6FA8 AFA200BC */  sw         $v0, 0xBC($sp)
/* 31BAC 800C6FAC 8C620000 */  lw         $v0, 0x0($v1)
/* 31BB0 800C6FB0 26520001 */  addiu      $s2, $s2, 0x1
...
/* 31BDC 800C6FDC 26520001 */   addiu     $s2, $s2, 0x1
/* 31BE0 800C6FE0 00041080 */  sll        $v0, $a0, 2
/* 31BE4 800C6FE4 82430000 */  lb         $v1, 0x0($s2)
...
/* 31BFC 800C6FFC 26520001 */  addiu      $s2, $s2, 0x1
.L800C7000:
/* 31C00 800C7000 92420000 */  lbu        $v0, 0x0($s2)
...
.L800C7014:
/* 31C14 800C7014 82450000 */  lb         $a1, 0x0($s2)
...
/* 31C34 800C7034 26520001 */   addiu     $s2, $s2, 0x1
.L800C7038:
/* 31C38 800C7038 00001021 */  addu       $v0, $zero, $zero
.L800C703C:
/* 31C3C 800C703C A3A20044 */  sb         $v0, 0x44($sp)
/* 31C40 800C7040 00021600 */  sll        $v0, $v0, 24
/* 31C44 800C7044 00021E03 */  sra        $v1, $v0, 24
...
/* 31C54 800C7054 82420000 */  lb         $v0, 0x0($s2)
...
/* 31C64 800C7064 26520001 */  addiu      $s2, $s2, 0x1
/* 31C68 800C7068 27A40010 */  addiu      $a0, $sp, 0x10
.L800C706C:
/* 31C6C 800C706C 82460000 */  lb         $a2, 0x0($s2)
...
/* 31CB4 800C70B4 30420004 */  andi       $v0, $v0, 0x4
...
/* 31ECC 800C72CC 30420004 */  andi       $v0, $v0, 0x4
/* 31ED0 800C72D0 1040FED2 */  beqz       $v0, .L800C6E1C
/* 31ED4 800C72D4 26450001 */   addiu     $a1, $s2, 0x1
...
/* 31F34 800C7334 26450001 */   addiu     $a1, $s2, 0x1
.L800C7338:
...
.size func_800C6DE0, . - func_800C6DE0
