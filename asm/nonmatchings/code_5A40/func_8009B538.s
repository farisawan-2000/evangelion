...
/* 6144 8009B544 3C02800D */  lui        $v0, %hi(PointerBankTables)
/* 6148 8009B548 00441021 */  addu       $v0, $v0, $a0
/* 614C 8009B54C 8C423A90 */  lw         $v0, %lo(PointerBankTables)($v0)
...
/* 615C 8009B55C 3C06800D */  lui        $a2, %hi(WaveBankTables)
/* 6160 8009B560 00C43021 */  addu       $a2, $a2, $a0
/* 6164 8009B564 8CC63A70 */  lw         $a2, %lo(WaveBankTables)($a2)
...
.size func_8009B538, . - func_8009B538
