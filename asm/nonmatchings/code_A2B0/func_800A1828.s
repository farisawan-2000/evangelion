...
/* C444 800A1844 8E420004 */  lw         $v0, 0x4($s2)
/* C448 800A1848 00A09821 */  addu       $s3, $a1, $zero
/* C44C 800A184C 8C430008 */  lw         $v1, 0x8($v0)
...
/* C478 800A1878 26100001 */  addiu      $s0, $s0, 0x1
...
.L800A188C:
/* C48C 800A188C 8E420008 */  lw         $v0, 0x8($s2)
/* C490 800A1890 00031C00 */  sll        $v1, $v1, 16
/* C494 800A1894 00031B83 */  sra        $v1, $v1, 14
/* C498 800A1898 00621821 */  addu       $v1, $v1, $v0
/* C49C 800A189C 8C620000 */  lw         $v0, 0x0($v1)
/* C4A0 800A18A0 8C420004 */  lw         $v0, 0x4($v0)
/* C4A4 800A18A4 50400003 */  beql       $v0, $zero, .L800A18B4
/* C4A8 800A18A8 00001021 */   addu      $v0, $zero, $zero
/* C4AC 800A18AC 90420005 */  lbu        $v0, 0x5($v0)
...
.size func_800A1828, . - func_800A1828
