...
/* C9CC 800A1DCC 8E420004 */  lw         $v0, 0x4($s2)
/* C9D0 800A1DD0 00A09821 */  addu       $s3, $a1, $zero
/* C9D4 800A1DD4 8C430008 */  lw         $v1, 0x8($v0)
...
/* CA00 800A1E00 54400003 */  bnel       $v0, $zero, .L800A1E10
/* CA04 800A1E04 26100001 */   addiu     $s0, $s0, 0x1
...
.L800A1E24:
/* CA24 800A1E24 8E430008 */  lw         $v1, 0x8($s2)
/* CA28 800A1E28 00021400 */  sll        $v0, $v0, 16
/* CA2C 800A1E2C 00021383 */  sra        $v0, $v0, 14
/* CA30 800A1E30 00431021 */  addu       $v0, $v0, $v1
/* CA34 800A1E34 8C420000 */  lw         $v0, 0x0($v0)
...
/* CA64 800A1E64 9082FFFE */  lbu        $v0, -0x2($a0)
/* CA68 800A1E68 00021023 */  negu       $v0, $v0
/* CA6C 800A1E6C A082FFFE */  sb         $v0, -0x2($a0)
.L800A1E70:
/* CA70 800A1E70 10E00004 */  beqz       $a3, .L800A1E84
/* CA74 800A1E74 00000000 */   nop
/* CA78 800A1E78 9082FFFF */  lbu        $v0, -0x1($a0)
/* CA7C 800A1E7C 00021023 */  negu       $v0, $v0
/* CA80 800A1E80 A082FFFF */  sb         $v0, -0x1($a0)
.L800A1E84:
/* CA84 800A1E84 11000004 */  beqz       $t0, .L800A1E98
/* CA88 800A1E88 24A50001 */   addiu     $a1, $a1, 0x1
/* CA8C 800A1E8C 90820000 */  lbu        $v0, 0x0($a0)
/* CA90 800A1E90 00021023 */  negu       $v0, $v0
/* CA94 800A1E94 A0820000 */  sb         $v0, 0x0($a0)
.L800A1E98:
...
.size func_800A1DA4, . - func_800A1DA4
