...
/* C588 800A1988 54400003 */  bnel       $v0, $zero, .L800A1998
/* C58C 800A198C 26100001 */   addiu     $s0, $s0, 0x1
...
.L800A19AC:
/* C5AC 800A19AC 8E620004 */  lw         $v0, 0x4($s3)
/* C5B0 800A19B0 8C430008 */  lw         $v1, 0x8($v0)
...
/* C5D0 800A19D0 54400003 */  bnel       $v0, $zero, .L800A19E0
/* C5D4 800A19D4 26100001 */   addiu     $s0, $s0, 0x1
...
.L800A19F4:
/* C5F4 800A19F4 2E420001 */  sltiu      $v0, $s2, 0x1
/* C5F8 800A19F8 2E630001 */  sltiu      $v1, $s3, 0x1
/* C5FC 800A19FC 00431025 */  or         $v0, $v0, $v1
/* C600 800A1A00 14400012 */  bnez       $v0, .L800A1A4C
/* C604 800A1A04 00141400 */   sll       $v0, $s4, 16
/* C608 800A1A08 8E430008 */  lw         $v1, 0x8($s2)
/* C60C 800A1A0C 00021383 */  sra        $v0, $v0, 14
/* C610 800A1A10 00431021 */  addu       $v0, $v0, $v1
/* C614 800A1A14 8C440000 */  lw         $a0, 0x0($v0)
/* C618 800A1A18 8E630008 */  lw         $v1, 0x8($s3)
/* C61C 800A1A1C 00051400 */  sll        $v0, $a1, 16
/* C620 800A1A20 00021383 */  sra        $v0, $v0, 14
/* C624 800A1A24 00431021 */  addu       $v0, $v0, $v1
/* C628 800A1A28 8C430000 */  lw         $v1, 0x0($v0)
/* C62C 800A1A2C 8C8500A0 */  lw         $a1, 0xA0($a0)
/* C630 800A1A30 8C6200A0 */  lw         $v0, 0xA0($v1)
/* C634 800A1A34 AC8200A0 */  sw         $v0, 0xA0($a0)
/* C638 800A1A38 8C620008 */  lw         $v0, 0x8($v1)
/* C63C 800A1A3C AC6500A0 */  sw         $a1, 0xA0($v1)
/* C640 800A1A40 8C850008 */  lw         $a1, 0x8($a0)
/* C644 800A1A44 AC820008 */  sw         $v0, 0x8($a0)
/* C648 800A1A48 AC650008 */  sw         $a1, 0x8($v1)
.L800A1A4C:
...
.size func_800A1934, . - func_800A1934
