...
/* 2B558 800C0958 0C0319D0 */  jal        __osDisableInt
/* 2B55C 800C095C AFB10014 */   sw        $s1, 0x14($sp)
/* 2B560 800C0960 8E030008 */  lw         $v1, 0x8($s0)
...
/* 2B574 800C0974 24140001 */  addiu      $s4, $zero, 0x1
/* 2B578 800C0978 24130008 */  addiu      $s3, $zero, 0x8
.L800C097C:
/* 2B57C 800C097C 12540005 */  beq        $s2, $s4, .L800C0994
/* 2B580 800C0980 26040004 */   addiu     $a0, $s0, 0x4
/* 2B584 800C0984 0C0319EC */  jal        __osRestoreInt
/* 2B588 800C0988 02202021 */   addu      $a0, $s1, $zero
/* 2B58C 800C098C 0803028F */  j          .L800C0A3C
/* 2B590 800C0990 2402FFFF */   addiu     $v0, $zero, -0x1
.L800C0994:
/* 2B594 800C0994 3C02800F */  lui        $v0, %hi(__osRunningThread)
/* 2B598 800C0998 8C4269C0 */  lw         $v0, %lo(__osRunningThread)($v0)
/* 2B59C 800C099C 0C031913 */  jal        __osEnqueueAndYield
/* 2B5A0 800C09A0 A4530010 */   sh        $s3, 0x10($v0)
/* 2B5A4 800C09A4 8E020008 */  lw         $v0, 0x8($s0)
...
/* 2B5BC 800C09BC 8E040008 */  lw         $a0, 0x8($s0)
...
.L800C09D8:
/* 2B5D8 800C09D8 2401FFFF */  addiu      $at, $zero, -0x1
/* 2B5DC 800C09DC 14410004 */  bne        $v0, $at, .L800C09F0
/* 2B5E0 800C09E0 3C018000 */   lui       $at, (0x80000000 >> 16)
...
/* 2B600 800C0A00 AC550000 */  sw         $s5, 0x0($v0)
/* 2B604 800C0A04 8E020008 */  lw         $v0, 0x8($s0)
/* 2B608 800C0A08 8E030000 */  lw         $v1, 0x0($s0)
/* 2B60C 800C0A0C 24420001 */  addiu      $v0, $v0, 0x1
/* 2B610 800C0A10 AE020008 */  sw         $v0, 0x8($s0)
/* 2B614 800C0A14 8C620000 */  lw         $v0, 0x0($v1)
/* 2B618 800C0A18 10400005 */  beqz       $v0, .L800C0A30
/* 2B61C 800C0A1C 00000000 */   nop
/* 2B620 800C0A20 0C031967 */  jal        __osPopThread
/* 2B624 800C0A24 02002021 */   addu      $a0, $s0, $zero
/* 2B628 800C0A28 0C0306CC */  jal        osStartThread
/* 2B62C 800C0A2C 00402021 */   addu      $a0, $v0, $zero
.L800C0A30:
/* 2B630 800C0A30 0C0319EC */  jal        __osRestoreInt
...
.size func_800C0930, . - func_800C0930
