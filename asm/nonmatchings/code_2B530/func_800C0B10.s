...
/* 2B820 800C0C20 30420001 */  andi       $v0, $v0, 0x1
...
/* 2B89C 800C0C9C 2410FFFF */  addiu      $s0, $zero, -0x1
/* 2B8A0 800C0CA0 3C040400 */  lui        $a0, (0x4001000 >> 16)
.L800C0CA4:
/* 2B8A4 800C0CA4 0C031E60 */  jal        func_800C7980
/* 2B8A8 800C0CA8 34841000 */   ori       $a0, $a0, (0x4001000 & 0xFFFF)
/* 2B8AC 800C0CAC 1050FFFD */  beq        $v0, $s0, .L800C0CA4
/* 2B8B0 800C0CB0 3C040400 */   lui       $a0, (0x4001000 >> 16)
/* 2B8B4 800C0CB4 2410FFFF */  addiu      $s0, $zero, -0x1
/* 2B8B8 800C0CB8 24040001 */  addiu      $a0, $zero, 0x1
.L800C0CBC:
/* 2B8BC 800C0CBC 3C050400 */  lui        $a1, (0x4000FC0 >> 16)
/* 2B8C0 800C0CC0 34A50FC0 */  ori        $a1, $a1, (0x4000FC0 & 0xFFFF)
...
/* 2B8D4 800C0CD4 24040001 */   addiu     $a0, $zero, 0x1
.L800C0CD8:
/* 2B8D8 800C0CD8 0C031E50 */  jal        func_800C7940
/* 2B8DC 800C0CDC 00000000 */   nop
/* 2B8E0 800C0CE0 1440FFFD */  bnez       $v0, .L800C0CD8
/* 2B8E4 800C0CE4 24040001 */   addiu     $a0, $zero, 0x1
/* 2B8E8 800C0CE8 2410FFFF */  addiu      $s0, $zero, -0x1
.L800C0CEC:
/* 2B8EC 800C0CEC 8E260008 */  lw         $a2, 0x8($s1)
/* 2B8F0 800C0CF0 8E27000C */  lw         $a3, 0xC($s1)
/* 2B8F4 800C0CF4 3C050400 */  lui        $a1, (0x4001000 >> 16)
/* 2B8F8 800C0CF8 0C031E6C */  jal        func_800C79B0
/* 2B8FC 800C0CFC 34A51000 */   ori       $a1, $a1, (0x4001000 & 0xFFFF)
/* 2B900 800C0D00 1050FFFA */  beq        $v0, $s0, .L800C0CEC
/* 2B904 800C0D04 24040001 */   addiu     $a0, $zero, 0x1
...
.size func_800C0B10, . - func_800C0B10
