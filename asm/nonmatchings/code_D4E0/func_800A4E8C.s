...
/* FB24 800A4F24 24A50004 */   addiu     $a1, $a1, 0x4
.L800A4F28:
/* FB28 800A4F28 93A3002F */  lbu        $v1, 0x2F($sp)
/* FB2C 800A4F2C 24020001 */  addiu      $v0, $zero, 0x1
/* FB30 800A4F30 1062000F */  beq        $v1, $v0, .L800A4F70
/* FB34 800A4F34 28620002 */   slti      $v0, $v1, 0x2
/* FB38 800A4F38 50400005 */  beql       $v0, $zero, .L800A4F50
/* FB3C 800A4F3C 24020002 */   addiu     $v0, $zero, 0x2
...
/* FBE4 800A4FE4 94830002 */  lhu        $v1, 0x2($a0)
...
.L800A501C:
/* FC1C 800A501C 90C20000 */  lbu        $v0, 0x0($a2)
/* FC20 800A5020 24A50001 */  addiu      $a1, $a1, 0x1
/* FC24 800A5024 00021102 */  srl        $v0, $v0, 4
/* FC28 800A5028 00431021 */  addu       $v0, $v0, $v1
/* FC2C 800A502C A2220000 */  sb         $v0, 0x0($s1)
/* FC30 800A5030 90C20000 */  lbu        $v0, 0x0($a2)
/* FC34 800A5034 26310001 */  addiu      $s1, $s1, 0x1
/* FC38 800A5038 24C60001 */  addiu      $a2, $a2, 0x1
/* FC3C 800A503C 3042000F */  andi       $v0, $v0, 0xF
/* FC40 800A5040 00431021 */  addu       $v0, $v0, $v1
/* FC44 800A5044 A2220000 */  sb         $v0, 0x0($s1)
/* FC48 800A5048 00A7102B */  sltu       $v0, $a1, $a3
/* FC4C 800A504C 1440FFF3 */  bnez       $v0, .L800A501C
/* FC50 800A5050 26310001 */   addiu     $s1, $s1, 0x1
.L800A5054:
/* FC54 800A5054 0C0326A1 */  jal        func_800C9A84
/* FC58 800A5058 26730004 */   addiu     $s3, $s3, 0x4
/* FC5C 800A505C 26520001 */  addiu      $s2, $s2, 0x1
/* FC60 800A5060 0257102A */  slt        $v0, $s2, $s7
/* FC64 800A5064 1440FFD3 */  bnez       $v0, .L800A4FB4
/* FC68 800A5068 00000000 */   nop
.L800A506C:
/* FC6C 800A506C 26A40008 */  addiu      $a0, $s5, 0x8
/* FC70 800A5070 3C058010 */  lui        $a1, %hi(D_800F9E8C)
/* FC74 800A5074 24A59E8C */  addiu      $a1, $a1, %lo(D_800F9E8C)
/* FC78 800A5078 24020001 */  addiu      $v0, $zero, 0x1
/* FC7C 800A507C A6B00000 */  sh         $s0, 0x0($s5)
/* FC80 800A5080 A6B40002 */  sh         $s4, 0x2($s5)
/* FC84 800A5084 0C030180 */  jal        func_800C0600
/* FC88 800A5088 A2A20004 */   sb        $v0, 0x4($s5)
/* FC8C 800A508C 93A3002F */  lbu        $v1, 0x2F($sp)
/* FC90 800A5090 24020001 */  addiu      $v0, $zero, 0x1
/* FC94 800A5094 1062000F */  beq        $v1, $v0, .L800A50D4
/* FC98 800A5098 28620002 */   slti      $v0, $v1, 0x2
/* FC9C 800A509C 50400005 */  beql       $v0, $zero, .L800A50B4
/* FCA0 800A50A0 24020002 */   addiu     $v0, $zero, 0x2
...
.size func_800A4E8C, . - func_800A4E8C
