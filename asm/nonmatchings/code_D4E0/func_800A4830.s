...
/* F468 800A4868 92530004 */  lbu        $s3, 0x4($s2)
/* F46C 800A486C 96560000 */  lhu        $s6, 0x0($s2)
/* F470 800A4870 965E0002 */  lhu        $fp, 0x2($s2)
/* F474 800A4874 24020001 */  addiu      $v0, $zero, 0x1
/* F478 800A4878 3263FFFF */  andi       $v1, $s3, 0xFFFF
/* F47C 800A487C 1062000C */  beq        $v1, $v0, .L800A48B0
/* F480 800A4880 00E0A821 */   addu      $s5, $a3, $zero
/* F484 800A4884 28620002 */  slti       $v0, $v1, 0x2
/* F488 800A4888 50400005 */  beql       $v0, $zero, .L800A48A0
/* F48C 800A488C 28620004 */   slti      $v0, $v1, 0x4
/* F490 800A4890 50600008 */  beql       $v1, $zero, .L800A48B4
/* F494 800A4894 24140002 */   addiu     $s4, $zero, 0x2
...
.L800A48B0:
/* F4B0 800A48B0 24140002 */  addiu      $s4, $zero, 0x2
.L800A48B4:
/* F4B4 800A48B4 32A300FF */  andi       $v1, $s5, 0xFF
.L800A48B8:
/* F4B8 800A48B8 24020001 */  addiu      $v0, $zero, 0x1
/* F4BC 800A48BC 1062000F */  beq        $v1, $v0, .L800A48FC
/* F4C0 800A48C0 28620002 */   slti      $v0, $v1, 0x2
/* F4C4 800A48C4 50400005 */  beql       $v0, $zero, .L800A48DC
/* F4C8 800A48C8 24020002 */   addiu     $v0, $zero, 0x2
...
.L800A4924:
/* F524 800A4924 240B0001 */  addiu      $t3, $zero, 0x1
/* F528 800A4928 02601821 */  addu       $v1, $s3, $zero
/* F52C 800A492C 28680002 */  slti       $t0, $v1, 0x2
/* F530 800A4930 240A0002 */  addiu      $t2, $zero, 0x2
/* F534 800A4934 24090003 */  addiu      $t1, $zero, 0x3
/* F538 800A4938 32C7FFFF */  andi       $a3, $s6, 0xFFFF
/* F53C 800A493C 26040030 */  addiu      $a0, $s0, 0x30
/* F540 800A4940 26110058 */  addiu      $s1, $s0, 0x58
/* F544 800A4944 AE040000 */  sw         $a0, 0x0($s0)
/* F548 800A4948 AE110004 */  sw         $s1, 0x4($s0)
/* F54C 800A494C AE000008 */  sw         $zero, 0x8($s0)
...
/* F580 800A4980 24020005 */  addiu      $v0, $zero, 0x5
...
.L800A49C4:
/* F5C4 800A49C4 94A20000 */  lhu        $v0, 0x0($a1)
...
.L800A4A84:
/* F684 800A4A84 8E240004 */  lw         $a0, 0x4($s1)
/* F688 800A4A88 02001021 */  addu       $v0, $s0, $zero
/* F68C 800A4A8C 2403FFFF */  addiu      $v1, $zero, -0x1
...
.size func_800A4830, . - func_800A4830
