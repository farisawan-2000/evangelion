...
/* 2CB38 800C1F38 8C620000 */  lw         $v0, 0x0($v1)
...
/* 2CB4C 800C1F4C 8C500000 */  lw         $s0, 0x0($v0)
...
.L800C1FE4:
/* 2CBE4 800C1FE4 8E030004 */  lw         $v1, 0x4($s0)
/* 2CBE8 800C1FE8 8E020000 */  lw         $v0, 0x0($s0)
/* 2CBEC 800C1FEC AC620000 */  sw         $v0, 0x0($v1)
/* 2CBF0 800C1FF0 8E030000 */  lw         $v1, 0x0($s0)
/* 2CBF4 800C1FF4 8E020004 */  lw         $v0, 0x4($s0)
/* 2CBF8 800C1FF8 AC620004 */  sw         $v0, 0x4($v1)
/* 2CBFC 800C1FFC 8E040018 */  lw         $a0, 0x18($s0)
/* 2CC00 800C2000 AE000000 */  sw         $zero, 0x0($s0)
/* 2CC04 800C2004 10800004 */  beqz       $a0, .L800C2018
/* 2CC08 800C2008 AE000004 */   sw        $zero, 0x4($s0)
/* 2CC0C 800C200C 8E05001C */  lw         $a1, 0x1C($s0)
/* 2CC10 800C2010 0C03024C */  jal        func_800C0930
/* 2CC14 800C2014 00003021 */   addu      $a2, $zero, $zero
.L800C2018:
/* 2CC18 800C2018 8E020008 */  lw         $v0, 0x8($s0)
...
.L800C2030:
/* 2CC30 800C2030 8E020008 */  lw         $v0, 0x8($s0)
...
.size func_800C1F24, . - func_800C1F24
