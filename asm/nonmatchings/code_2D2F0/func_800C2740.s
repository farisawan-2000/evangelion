...
/* 2D370 800C2770 34420008 */  ori        $v0, $v0, 0x8
/* 2D374 800C2774 AC62000C */  sw         $v0, 0xC($v1)
/* 2D378 800C2778 32020002 */  andi       $v0, $s0, 0x2
.L800C277C:
/* 2D37C 800C277C 10400006 */  beqz       $v0, .L800C2798
/* 2D380 800C2780 2404FFF7 */   addiu     $a0, $zero, -0x9
...
.L800C2798:
/* 2D398 800C2798 32020004 */  andi       $v0, $s0, 0x4
/* 2D39C 800C279C 10400007 */  beqz       $v0, .L800C27BC
/* 2D3A0 800C27A0 32020008 */   andi      $v0, $s0, 0x8
...
/* 2D3B0 800C27B0 34420004 */  ori        $v0, $v0, 0x4
/* 2D3B4 800C27B4 AC62000C */  sw         $v0, 0xC($v1)
/* 2D3B8 800C27B8 32020008 */  andi       $v0, $s0, 0x8
.L800C27BC:
/* 2D3BC 800C27BC 10400006 */  beqz       $v0, .L800C27D8
/* 2D3C0 800C27C0 2404FFFB */   addiu     $a0, $zero, -0x5
...
/* 2D420 800C2820 3C030001 */   lui       $v1, (0x10000 >> 16)
...
/* 2D448 800C2848 3C02FFFE */   lui       $v0, (0xFFFEFFFF >> 16)
...
/* 2D458 800C2858 8C850008 */  lw         $a1, 0x8($a0)
/* 2D45C 800C285C 3442FFFF */  ori        $v0, $v0, (0xFFFEFFFF & 0xFFFF)
/* 2D460 800C2860 00621824 */  and        $v1, $v1, $v0
/* 2D464 800C2864 AC83000C */  sw         $v1, 0xC($a0)
/* 2D468 800C2868 8CA20004 */  lw         $v0, 0x4($a1)
...
/* 2D480 800C2880 94620000 */  lhu        $v0, 0x0($v1)
/* 2D484 800C2884 00C02021 */  addu       $a0, $a2, $zero
/* 2D488 800C2888 34420008 */  ori        $v0, $v0, 0x8
/* 2D48C 800C288C 0C0319EC */  jal        __osRestoreInt
/* 2D490 800C2890 A4620000 */   sh        $v0, 0x0($v1)
...
.size func_800C2740, . - func_800C2740
