...
.L800C5C5C:
/* 3085C 800C5C5C AC600000 */  sw         $zero, 0x0($v1)
/* 30860 800C5C60 2442FFFF */  addiu      $v0, $v0, -0x1
/* 30864 800C5C64 0441FFFD */  bgez       $v0, .L800C5C5C
/* 30868 800C5C68 2463FFFC */   addiu     $v1, $v1, -0x4
/* 3086C 800C5C6C 3C038015 */  lui        $v1, %hi(D_8014A29C)
/* 30870 800C5C70 2463A29C */  addiu      $v1, $v1, %lo(D_8014A29C)
/* 30874 800C5C74 24020001 */  addiu      $v0, $zero, 0x1
/* 30878 800C5C78 AC620000 */  sw         $v0, 0x0($v1)
/* 3087C 800C5C7C 2466FFC4 */  addiu      $a2, $v1, -0x3C
/* 30880 800C5C80 24020003 */  addiu      $v0, $zero, 0x3
.L800C5C84:
/* 30884 800C5C84 A0C00000 */  sb         $zero, 0x0($a2)
/* 30888 800C5C88 2442FFFF */  addiu      $v0, $v0, -0x1
/* 3088C 800C5C8C 0441FFFD */  bgez       $v0, .L800C5C84
/* 30890 800C5C90 24C60001 */   addiu     $a2, $a2, 0x1
/* 30894 800C5C94 240300FF */  addiu      $v1, $zero, 0xFF
/* 30898 800C5C98 24020001 */  addiu      $v0, $zero, 0x1
/* 3089C 800C5C9C A3A20011 */  sb         $v0, 0x11($sp)
/* 308A0 800C5CA0 24020003 */  addiu      $v0, $zero, 0x3
...
/* 308D0 800C5CD0 A8C20000 */  swl        $v0, 0x0($a2)
/* 308D4 800C5CD4 B8C20003 */  swr        $v0, 0x3($a2)
/* 308D8 800C5CD8 A8C30004 */  swl        $v1, 0x4($a2)
/* 308DC 800C5CDC B8C30007 */  swr        $v1, 0x7($a2)
/* 308E0 800C5CE0 24040001 */  addiu      $a0, $zero, 0x1
...
/* 308F8 800C5CF8 A0D00008 */   sb        $s0, 0x8($a2)
...
/* 30908 800C5D08 24060001 */   addiu     $a2, $zero, 0x1
...
/* 30928 800C5D28 24060001 */  addiu      $a2, $zero, 0x1
...
/* 30940 800C5D40 24020003 */  addiu      $v0, $zero, 0x3
.L800C5D44:
/* 30944 800C5D44 A0C00000 */  sb         $zero, 0x0($a2)
/* 30948 800C5D48 2442FFFF */  addiu      $v0, $v0, -0x1
/* 3094C 800C5D4C 0441FFFD */  bgez       $v0, .L800C5D44
/* 30950 800C5D50 24C60001 */   addiu     $a2, $a2, 0x1
/* 30954 800C5D54 88C20000 */  lwl        $v0, 0x0($a2)
/* 30958 800C5D58 98C20003 */  lwr        $v0, 0x3($a2)
/* 3095C 800C5D5C 88C30004 */  lwl        $v1, 0x4($a2)
/* 30960 800C5D60 98C30007 */  lwr        $v1, 0x7($a2)
...
/* 309AC 800C5DAC A2430002 */  sb         $v1, 0x2($s2)
.L800C5DB0:
...
.size func_800C5C30, . - func_800C5C30
