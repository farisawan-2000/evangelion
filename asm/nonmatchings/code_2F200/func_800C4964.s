...
.L800C49A4:
/* 2F5A4 800C49A4 24130001 */  addiu      $s3, $zero, 0x1
/* 2F5A8 800C49A8 27B0001A */  addiu      $s0, $sp, 0x1A
/* 2F5AC 800C49AC 24020001 */  addiu      $v0, $zero, 0x1
/* 2F5B0 800C49B0 A7A20018 */  sh         $v0, 0x18($sp)
/* 2F5B4 800C49B4 24020003 */  addiu      $v0, $zero, 0x3
/* 2F5B8 800C49B8 A7A2001A */  sh         $v0, 0x1A($sp)
/* 2F5BC 800C49BC 24020004 */  addiu      $v0, $zero, 0x4
/* 2F5C0 800C49C0 A7A2001C */  sh         $v0, 0x1C($sp)
/* 2F5C4 800C49C4 24020006 */  addiu      $v0, $zero, 0x6
/* 2F5C8 800C49C8 A7A2001E */  sh         $v0, 0x1E($sp)
.L800C49CC:
/* 2F5CC 800C49CC 8E840004 */  lw         $a0, 0x4($s4)
/* 2F5D0 800C49D0 8E850008 */  lw         $a1, 0x8($s4)
/* 2F5D4 800C49D4 96060000 */  lhu        $a2, 0x0($s0)
...
.L800C49F4:
/* 2F5F4 800C49F4 94A20000 */  lhu        $v0, 0x0($a1)
/* 2F5F8 800C49F8 97A30020 */  lhu        $v1, 0x20($sp)
/* 2F5FC 800C49FC 97A40022 */  lhu        $a0, 0x22($sp)
/* 2F600 800C4A00 24A50002 */  addiu      $a1, $a1, 0x2
...
/* 2F62C 800C4A2C 26730001 */   addiu     $s3, $s3, 0x1
...
/* 2F63C 800C4A3C 24020004 */   addiu     $v0, $zero, 0x4
/* 2F640 800C4A40 26730001 */  addiu      $s3, $s3, 0x1
.L800C4A44:
/* 2F644 800C4A44 2A620004 */  slti       $v0, $s3, 0x4
/* 2F648 800C4A48 1440FFE0 */  bnez       $v0, .L800C49CC
/* 2F64C 800C4A4C 26100002 */   addiu     $s0, $s0, 0x2
/* 2F650 800C4A50 24020004 */  addiu      $v0, $zero, 0x4
.L800C4A54:
...
.L800C4A64:
/* 2F664 800C4A64 24150001 */  addiu      $s5, $zero, 0x1
/* 2F668 800C4A68 27B10018 */  addiu      $s1, $sp, 0x18
.L800C4A6C:
/* 2F66C 800C4A6C 52130009 */  beql       $s0, $s3, .L800C4A94
/* 2F670 800C4A70 26100001 */   addiu     $s0, $s0, 0x1
/* 2F674 800C4A74 96260000 */  lhu        $a2, 0x0($s1)
/* 2F678 800C4A78 AFB50010 */  sw         $s5, 0x10($sp)
/* 2F67C 800C4A7C 8E840004 */  lw         $a0, 0x4($s4)
/* 2F680 800C4A80 8E850008 */  lw         $a1, 0x8($s4)
...
/* 2F690 800C4A90 26100001 */   addiu     $s0, $s0, 0x1
.L800C4A94:
/* 2F694 800C4A94 2A020004 */  slti       $v0, $s0, 0x4
/* 2F698 800C4A98 1440FFF4 */  bnez       $v0, .L800C4A6C
/* 2F69C 800C4A9C 26310002 */   addiu     $s1, $s1, 0x2
...
.size func_800C4964, . - func_800C4964
