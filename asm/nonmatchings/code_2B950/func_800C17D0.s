...
/* 2C420 800C1820 3C03A480 */  lui        $v1, (0xA4800010 >> 16)
/* 2C424 800C1824 AC620000 */  sw         $v0, %lo(D_A4800000)($v1)
/* 2C428 800C1828 56000003 */  bnel       $s0, $zero, .L800C1838
/* 2C42C 800C182C 3C03A480 */   lui       $v1, (0xA4800010 >> 16)
/* 2C430 800C1830 0803060F */  j          .L800C183C
/* 2C434 800C1834 34630004 */   ori       $v1, $v1, (0xA4800004 & 0xFFFF)
.L800C1838:
/* 2C438 800C1838 34630010 */  ori        $v1, $v1, (0xA4800010 & 0xFFFF)
.L800C183C:
/* 2C43C 800C183C 3C021FC0 */  lui        $v0, (0x1FC007C0 >> 16)
/* 2C440 800C1840 344207C0 */  ori        $v0, $v0, (0x1FC007C0 & 0xFFFF)
/* 2C444 800C1844 AC620000 */  sw         $v0, 0x0($v1)
...
.size func_800C17D0, . - func_800C17D0
