...
/* 2C744 800C1B44 0C0319D0 */  jal        __osDisableInt
...
/* 2C76C 800C1B6C 3C04800F */  lui        $a0, %hi(__osRunQueue)
/* 2C770 800C1B70 248469B8 */  addiu      $a0, $a0, %lo(__osRunQueue)
...
/* 2C788 800C1B88 3C11800F */  lui        $s1, %hi(__osRunQueue)
/* 2C78C 800C1B8C 263169B8 */  addiu      $s1, $s1, %lo(__osRunQueue)
...
/* 2C7A0 800C1BA0 3C04800F */  lui        $a0, %hi(__osRunQueue)
/* 2C7A4 800C1BA4 248469B8 */  addiu      $a0, $a0, %lo(__osRunQueue)
...
/* 2C7B8 800C1BB8 0C031955 */  jal        __osEnqueueThread
/* 2C7BC 800C1BBC A6020010 */   sh        $v0, 0x10($s0)
/* 2C7C0 800C1BC0 8E040008 */  lw         $a0, 8($s0)
/* 2C7C4 800C1BC4 0C031967 */  jal        __osPopThread
/* 2C7C8 800C1BC8 00000000 */   nop
/* 2C7CC 800C1BCC 02202021 */  addu       $a0, $s1, $zero
/* 2C7D0 800C1BD0 00402821 */  addu       $a1, $v0, $zero
.L800C1BD4:
/* 2C7D4 800C1BD4 0C031955 */  jal        __osEnqueueThread
/* 2C7D8 800C1BD8 00000000 */   nop
.L800C1BDC:
/* 2C7DC 800C1BDC 3C04800F */  lui        $a0, %hi(__osRunningThread)
/* 2C7E0 800C1BE0 8C8469C0 */  lw         $a0, %lo(__osRunningThread)($a0)
/* 2C7E4 800C1BE4 14800005 */  bnez       $a0, .L800C1BFC
/* 2C7E8 800C1BE8 00000000 */   nop
/* 2C7EC 800C1BEC 0C03196B */  jal        __osDispatchThread
/* 2C7F0 800C1BF0 00000000 */   nop
/* 2C7F4 800C1BF4 0803070A */  j          .L800C1C28
/* 2C7F8 800C1BF8 00000000 */   nop
.L800C1BFC:
/* 2C7FC 800C1BFC 3C02800F */  lui        $v0, %hi(__osRunQueue)
/* 2C800 800C1C00 8C4269B8 */  lw         $v0, %lo(__osRunQueue)($v0)
...
/* 2C81C 800C1C1C 3C04800F */  lui        $a0, %hi(__osRunQueue)
/* 2C820 800C1C20 0C031913 */  jal        __osEnqueueAndYield
/* 2C824 800C1C24 248469B8 */   addiu     $a0, $a0, %lo(__osRunQueue)
.L800C1C28:
/* 2C828 800C1C28 0C0319EC */  jal        __osRestoreInt
