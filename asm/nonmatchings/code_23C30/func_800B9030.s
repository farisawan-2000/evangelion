...
/* 23C68 800B9068 A0400000 */  sb         $zero, 0x0($v0)
/* 23C6C 800B906C 3C02B000 */  lui        $v0, (0xB0000000 >> 16)
...
/* 23C88 800B9088 0C030134 */  jal        bzero
/* 23C8C 800B908C 24050060 */   addiu     $a1, $zero, 0x60
/* 23C90 800B9090 3C02A460 */  lui        $v0, (0xA4600010 >> 16)
/* 23C94 800B9094 34420010 */  ori        $v0, $v0, (0xA4600010 & 0xFFFF)
/* 23C98 800B9098 8C420000 */  lw         $v0, 0x0($v0)
/* 23C9C 800B909C 30420003 */  andi       $v0, $v0, 0x3
/* 23CA0 800B90A0 10400006 */  beqz       $v0, .L800B90BC
/* 23CA4 800B90A4 3C03A460 */   lui       $v1, (0xA4600010 >> 16)
/* 23CA8 800B90A8 34630010 */  ori        $v1, $v1, (0xA4600010 & 0xFFFF)
.L800B90AC:
/* 23CAC 800B90AC 8C620000 */  lw         $v0, 0x0($v1)
/* 23CB0 800B90B0 30420003 */  andi       $v0, $v0, 0x3
/* 23CB4 800B90B4 1440FFFD */  bnez       $v0, .L800B90AC
/* 23CB8 800B90B8 00000000 */   nop
.L800B90BC:
/* 23CBC 800B90BC 3C08A460 */  lui        $t0, (0xA4600014 >> 16)
/* 23CC0 800B90C0 35080014 */  ori        $t0, $t0, (0xA4600014 & 0xFFFF)
/* 23CC4 800B90C4 3C07A460 */  lui        $a3, (0xA460001C >> 16)
/* 23CC8 800B90C8 34E7001C */  ori        $a3, $a3, (0xA460001C & 0xFFFF)
/* 23CCC 800B90CC 3C06A460 */  lui        $a2, (0xA4600020 >> 16)
/* 23CD0 800B90D0 34C60020 */  ori        $a2, $a2, (0xA4600020 & 0xFFFF)
/* 23CD4 800B90D4 3C05A460 */  lui        $a1, (0xA4600018 >> 16)
/* 23CD8 800B90D8 34A50018 */  ori        $a1, $a1, (0xA4600018 & 0xFFFF)
/* 23CDC 800B90DC 8D090000 */  lw         $t1, 0x0($t0)
/* 23CE0 800B90E0 8CEA0000 */  lw         $t2, 0x0($a3)
/* 23CE4 800B90E4 8CCB0000 */  lw         $t3, 0x0($a2)
/* 23CE8 800B90E8 8CAC0000 */  lw         $t4, 0x0($a1)
/* 23CEC 800B90EC 3C118015 */  lui        $s1, %hi(D_8014A0D4)
/* 23CF0 800B90F0 2631A0D4 */  addiu      $s1, $s1, %lo(D_8014A0D4)
/* 23CF4 800B90F4 8E230000 */  lw         $v1, 0x0($s1)
/* 23CF8 800B90F8 240400FF */  addiu      $a0, $zero, 0xFF
/* 23CFC 800B90FC 24020003 */  addiu      $v0, $zero, 0x3
/* 23D00 800B9100 AD040000 */  sw         $a0, 0x0($t0)
/* 23D04 800B9104 ACE00000 */  sw         $zero, 0x0($a3)
/* 23D08 800B9108 ACC20000 */  sw         $v0, 0x0($a2)
/* 23D0C 800B910C 3C02A000 */  lui        $v0, %hi(D_A0000000)
/* 23D10 800B9110 ACA40000 */  sw         $a0, 0x0($a1)
/* 23D14 800B9114 00621825 */  or         $v1, $v1, $v0
/* 23D18 800B9118 8C630000 */  lw         $v1, %lo(D_A0000000)($v1)
/* 23D1C 800B911C AD090000 */  sw         $t1, 0x0($t0)
/* 23D20 800B9120 ACEA0000 */  sw         $t2, 0x0($a3)
/* 23D24 800B9124 ACCB0000 */  sw         $t3, 0x0($a2)
/* 23D28 800B9128 ACAC0000 */  sw         $t4, 0x0($a1)
/* 23D2C 800B912C 00031402 */  srl        $v0, $v1, 16
...
/* 23D3C 800B913C 00031502 */  srl        $v0, $v1, 20
...
/* 23D60 800B9160 0C0319D0 */  jal        __osDisableInt
...
/* 23D7C 800B917C 0C0319EC */  jal        __osRestoreInt
...
.size func_800B9030, . - func_800B9030
