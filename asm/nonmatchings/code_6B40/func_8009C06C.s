...
/* 6C6C 8009C06C 3C048015 */  lui        $a0, %hi(gDisplayListHead)
/* 6C70 8009C070 8C849F94 */  lw         $a0, %lo(gDisplayListHead)($a0)
/* 6C74 8009C074 3C03800D */  lui        $v1, %hi(D_800D3D40)
/* 6C78 8009C078 80633D40 */  lb         $v1, %lo(D_800D3D40)($v1)
/* 6C7C 8009C07C 3C06DE00 */  lui        $a2, (0xDE000000 >> 16)
/* 6C80 8009C080 24820008 */  addiu      $v0, $a0, 0x8
/* 6C84 8009C084 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 6C88 8009C088 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 6C8C 8009C08C 3C02DB06 */  lui        $v0, (0xDB060000 >> 16)
/* 6C90 8009C090 AC820000 */  sw         $v0, 0x0($a0)
/* 6C94 8009C094 24820010 */  addiu      $v0, $a0, 0x10
/* 6C98 8009C098 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 6C9C 8009C09C AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 6CA0 8009C0A0 3C02000D */  lui        $v0, %hi(D_D3CD8)
/* 6CA4 8009C0A4 24423CD8 */  addiu      $v0, $v0, %lo(D_D3CD8)
/* 6CA8 8009C0A8 AC800004 */  sw         $zero, 0x4($a0)
/* 6CAC 8009C0AC AC860008 */  sw         $a2, 0x8($a0)
/* 6CB0 8009C0B0 1060000A */  beqz       $v1, .L8009C0DC
/* 6CB4 8009C0B4 AC82000C */   sw        $v0, 0xC($a0)
/* 6CB8 8009C0B8 24820018 */  addiu      $v0, $a0, 0x18
/* 6CBC 8009C0BC 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 6CC0 8009C0C0 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 6CC4 8009C0C4 3C02000D */  lui        $v0, %hi(D_D3BF8)
/* 6CC8 8009C0C8 24423BF8 */  addiu      $v0, $v0, %lo(D_D3BF8)
...
.L8009C0DC:
/* 6CDC 8009C0DC 3C014080 */  lui        $at, (0x40800000 >> 16)
...
/* 6CF8 8009C0F8 3C058015 */  lui        $a1, %hi(gDisplayListHead)
/* 6CFC 8009C0FC 8CA59F94 */  lw         $a1, %lo(gDisplayListHead)($a1)
...
/* 6D0C 8009C10C 24A20008 */  addiu      $v0, $a1, 0x8
/* 6D10 8009C110 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 6D14 8009C114 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 6D18 8009C118 3C02000D */  lui        $v0, %hi(D_D3D20)
/* 6D1C 8009C11C 24423D20 */  addiu      $v0, $v0, %lo(D_D3D20)
/* 6D20 8009C120 00000000 */  nop
/* 6D24 8009C124 46061082 */  mul.s      $f2, $f2, $f6
/* 6D28 8009C128 ACA20004 */  sw         $v0, 0x4($a1)
/* 6D2C 8009C12C 24A20010 */  addiu      $v0, $a1, 0x10
/* 6D30 8009C130 ACA60000 */  sw         $a2, 0x0($a1)
/* 6D34 8009C134 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 6D38 8009C138 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
...
/* 6D5C 8009C15C 00021300 */  sll        $v0, $v0, 12
...
/* 6D70 8009C170 3C04ED00 */  lui        $a0, (0xED000000 >> 16)
...
/* 6D8C 8009C18C ACA20008 */  sw         $v0, 0x8($a1)
...
/* 6DA0 8009C1A0 00021300 */  sll        $v0, $v0, 12
...
.size func_8009C06C, . - func_8009C06C
