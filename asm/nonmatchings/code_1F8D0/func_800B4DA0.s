...
/* 1F9F8 800B4DF8 8C830008 */  lw         $v1, 0x8($a0)
/* 1F9FC 800B4DFC AC820088 */  sw         $v0, 0x88($a0)
/* 1FA00 800B4E00 AC600008 */  sw         $zero, 0x8($v1)
/* 1FA04 800B4E04 AC900008 */  sw         $s0, 0x8($a0)
/* 1FA08 800B4E08 0C02D5BA */  jal        func_800B56E8
/* 1FA0C 800B4E0C AE040008 */   sw        $a0, 0x8($s0)
...
/* 1FA70 800B4E70 A4C20008 */  sh         $v0, 0x8($a2)
/* 1FA74 800B4E74 ACC00000 */  sw         $zero, 0x0($a2)
/* 1FA78 800B4E78 00641821 */  addu       $v1, $v1, $a0
/* 1FA7C 800B4E7C ACC30004 */  sw         $v1, 0x4($a2)
/* 1FA80 800B4E80 8E040008 */  lw         $a0, 0x8($s0)
/* 1FA84 800B4E84 0C02CD62 */  jal        func_800B3588
/* 1FA88 800B4E88 24050003 */   addiu     $a1, $zero, 0x3
/* 1FA8C 800B4E8C 0802D3A8 */  j          .L800B4EA0
/* 1FA90 800B4E90 00000000 */   nop
.L800B4E94:
/* 1FA94 800B4E94 AC800088 */  sw         $zero, 0x88($a0)
/* 1FA98 800B4E98 AC900008 */  sw         $s0, 0x8($a0)
/* 1FA9C 800B4E9C AE040008 */  sw         $a0, 0x8($s0)
.L800B4EA0:
...
.size func_800B4DA0, . - func_800B4DA0
