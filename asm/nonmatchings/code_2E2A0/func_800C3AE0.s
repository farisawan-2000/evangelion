...
.L800C3B60:
/* 2E760 800C3B60 8E240004 */  lw         $a0, 0x4($s1)
/* 2E764 800C3B64 8E26005C */  lw         $a2, 0x5C($s1)
/* 2E768 800C3B68 8E250008 */  lw         $a1, 0x8($s1)
...
/* 2E78C 800C3B8C 24020005 */   addiu     $v0, $zero, 0x5
...
/* 2E7A0 800C3BA0 24020005 */   addiu     $v0, $zero, 0x5
.L800C3BA4:
...
/* 2E7F4 800C3BF4 94500000 */  lhu        $s0, 0x0($v0)
/* 2E7F8 800C3BF8 08030EEC */  j          .L800C3BB0
/* 2E7FC 800C3BFC 26730001 */   addiu     $s3, $s3, 0x1
.L800C3C00:
/* 2E800 800C3C00 24020001 */  addiu      $v0, $zero, 0x1
/* 2E804 800C3C04 14620012 */  bne        $v1, $v0, .L800C3C50
/* 2E808 800C3C08 24020003 */   addiu     $v0, $zero, 0x3
/* 2E80C 800C3C0C 00131200 */  sll        $v0, $s3, 8
/* 2E810 800C3C10 AE820000 */  sw         $v0, 0x0($s4)
/* 2E814 800C3C14 97A20114 */  lhu        $v0, 0x114($sp)
/* 2E818 800C3C18 27A40120 */  addiu      $a0, $sp, 0x120
/* 2E81C 800C3C1C A6820008 */  sh         $v0, 0x8($s4)
...
/* 2E830 800C3C30 AE820004 */   sw        $v0, 0x4($s4)
...
/* 2E840 800C3C40 24060004 */   addiu     $a2, $zero, 0x4
/* 2E844 800C3C44 8E240004 */  lw         $a0, 0x4($s1)
/* 2E848 800C3C48 0C0310E0 */  jal        func_800C4380
/* 2E84C 800C3C4C 8E250008 */   lw        $a1, 0x8($s1)
.L800C3C50:
...
.size func_800C3AE0, . - func_800C3AE0
