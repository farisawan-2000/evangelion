...
/* 2E2D8 800C36D8 00151FC2 */  srl        $v1, $s5, 31
/* 2E2DC 800C36DC 02A2102A */  slt        $v0, $s5, $v0
/* 2E2E0 800C36E0 38420001 */  xori       $v0, $v0, 0x1
...
/* 2E2F8 800C36F8 544000EF */  bnel       $v0, $zero, .L800C3AB8
/* 2E2FC 800C36FC 24020005 */   addiu     $v0, $zero, 0x5
...
/* 2E30C 800C370C 24020005 */   addiu     $v0, $zero, 0x5
/* 2E310 800C3710 8E020000 */  lw         $v0, 0x0($s0)
/* 2E314 800C3714 30420001 */  andi       $v0, $v0, 0x1
/* 2E318 800C3718 104000E7 */  beqz       $v0, .L800C3AB8
/* 2E31C 800C371C 24020005 */   addiu     $v0, $zero, 0x5
/* 2E320 800C3720 0C031325 */  jal        func_800C4C94
/* 2E324 800C3724 02002021 */   addu      $a0, $s0, $zero
/* 2E328 800C3728 24030002 */  addiu      $v1, $zero, 0x2
/* 2E32C 800C372C 104300E2 */  beq        $v0, $v1, .L800C3AB8
/* 2E330 800C3730 24020002 */   addiu     $v0, $zero, 0x2
...
.L800C3754:
/* 2E354 800C3754 8E040004 */  lw         $a0, 0x4($s0)
/* 2E358 800C3758 8E06005C */  lw         $a2, 0x5C($s0)
/* 2E35C 800C375C 8E050008 */  lw         $a1, 0x8($s0)
...
/* 2E384 800C3784 24020005 */   addiu     $v0, $zero, 0x5
/* 2E388 800C3788 8FA20018 */  lw         $v0, 0x18($sp)
/* 2E38C 800C378C 104000CA */  beqz       $v0, .L800C3AB8
/* 2E390 800C3790 24020005 */   addiu     $v0, $zero, 0x5
...
/* 2E3C0 800C37C0 2C430001 */  sltiu      $v1, $v0, 0x1
/* 2E3C4 800C37C4 2C420080 */  sltiu      $v0, $v0, 0x80
/* 2E3C8 800C37C8 38420001 */  xori       $v0, $v0, 0x1
...
/* 2E3DC 800C37DC 24030001 */  addiu      $v1, $zero, 0x1
/* 2E3E0 800C37E0 148300B5 */  bne        $a0, $v1, .L800C3AB8
/* 2E3E4 800C37E4 24020003 */   addiu     $v0, $zero, 0x3
.L800C37E8:
/* 2E3E8 800C37E8 08030EAE */  j          .L800C3AB8
/* 2E3EC 800C37EC 24020005 */   addiu     $v0, $zero, 0x5
.L800C37F0:
...
/* 2E478 800C3878 94430000 */  lhu        $v1, 0x0($v0)
...
/* 2E4A8 800C38A8 2C430001 */  sltiu      $v1, $v0, 0x1
/* 2E4AC 800C38AC 2C420080 */  sltiu      $v0, $v0, 0x80
/* 2E4B0 800C38B0 38420001 */  xori       $v0, $v0, 0x1
...
/* 2E4C8 800C38C8 24030003 */   addiu     $v1, $zero, 0x3
/* 2E4CC 800C38CC 24030005 */  addiu      $v1, $zero, 0x5
.L800C38D0:
/* 2E4D0 800C38D0 14600074 */  bnez       $v1, .L800C3AA4
/* 2E4D4 800C38D4 2631FFF8 */   addiu     $s1, $s1, -0x8
/* 2E4D8 800C38D8 2A220008 */  slti       $v0, $s1, 0x8
...
/* 2E4FC 800C38FC 24160001 */  addiu      $s6, $zero, 0x1
.L800C3900:
/* 2E500 800C3900 24020008 */  addiu      $v0, $zero, 0x8
...
/* 2E548 800C3948 94430000 */  lhu        $v1, 0x0($v0)
...
/* 2E578 800C3978 2C430001 */  sltiu      $v1, $v0, 0x1
/* 2E57C 800C397C 2C420080 */  sltiu      $v0, $v0, 0x80
/* 2E580 800C3980 38420001 */  xori       $v0, $v0, 0x1
...
/* 2E598 800C3998 24030003 */   addiu     $v1, $zero, 0x3
/* 2E59C 800C399C 24030005 */  addiu      $v1, $zero, 0x5
.L800C39A0:
...
/* 2E5DC 800C39DC 54400008 */  bnel       $v0, $zero, .L800C3A00
/* 2E5E0 800C39E0 AFA00010 */   sw        $zero, 0x10($sp)
/* 2E5E4 800C39E4 8E040004 */  lw         $a0, 0x4($s0)
/* 2E5E8 800C39E8 8E050008 */  lw         $a1, 0x8($s0)
...
.L800C3A00:
/* 2E600 800C3A00 8E040004 */  lw         $a0, 0x4($s0)
/* 2E604 800C3A04 8E050008 */  lw         $a1, 0x8($s0)
...
/* 2E678 800C3A78 8E040004 */  lw         $a0, 0x4($s0)
/* 2E67C 800C3A7C 8E050008 */  lw         $a1, 0x8($s0)
...
.L800C3AAC:
/* 2E6AC 800C3AAC 8E040004 */  lw         $a0, 0x4($s0)
/* 2E6B0 800C3AB0 0C0310E0 */  jal        func_800C4380
/* 2E6B4 800C3AB4 8E050008 */   lw        $a1, 0x8($s0)
.L800C3AB8:
...
.size func_800C36A0, . - func_800C36A0
