...
/* 1EF34 800B4334 25080008 */  addiu      $t0, $t0, 0x8
/* 1EF38 800B4338 3C070C00 */  lui        $a3, (0xC00DA83 >> 16)
/* 1EF3C 800B433C 34E7DA83 */  ori        $a3, $a3, (0xC00DA83 & 0xFFFF)
/* 1EF40 800B4340 3C0407C0 */  lui        $a0, (0x7C007C0 >> 16)
/* 1EF44 800B4344 348407C0 */  ori        $a0, $a0, (0x7C007C0 & 0xFFFF)
/* 1EF48 800B4348 3C050C00 */  lui        $a1, (0xC005A82 >> 16)
/* 1EF4C 800B434C 34A55A82 */  ori        $a1, $a1, (0xC005A82 & 0xFFFF)
/* 1EF50 800B4350 3C020930 */  lui        $v0, (0x93007C0 >> 16)
/* 1EF54 800B4354 344207C0 */  ori        $v0, $v0, (0x93007C0 & 0xFFFF)
/* 1EF58 800B4358 240607C0 */  addiu      $a2, $zero, 0x7C0
/* 1EF5C 800B435C AC670000 */  sw         $a3, 0x0($v1)
/* 1EF60 800B4360 01003821 */  addu       $a3, $t0, $zero
/* 1EF64 800B4364 AC640004 */  sw         $a0, 0x4($v1)
/* 1EF68 800B4368 ACE50000 */  sw         $a1, 0x0($a3)
/* 1EF6C 800B436C ACE20004 */  sw         $v0, 0x4($a3)
/* 1EF70 800B4370 8E450018 */  lw         $a1, 0x18($s2)
/* 1EF74 800B4374 24E70008 */  addiu      $a3, $a3, 0x8
/* 1EF78 800B4378 0C02D2C6 */  jal        func_800B4B18
/* 1EF7C 800B437C 02402021 */   addu      $a0, $s2, $zero
/* 1EF80 800B4380 00404021 */  addu       $t0, $v0, $zero
/* 1EF84 800B4384 3C020200 */  lui        $v0, (0x2000930 >> 16)
/* 1EF88 800B4388 34420930 */  ori        $v0, $v0, (0x2000930 & 0xFFFF)
/* 1EF8C 800B438C 01001821 */  addu       $v1, $t0, $zero
/* 1EF90 800B4390 AC620000 */  sw         $v0, 0x0($v1)
/* 1EF94 800B4394 24020170 */  addiu      $v0, $zero, 0x170
/* 1EF98 800B4398 AC620004 */  sw         $v0, 0x4($v1)
/* 1EF9C 800B439C 92420024 */  lbu        $v0, 0x24($s2)
/* 1EFA0 800B43A0 00008021 */  addu       $s0, $zero, $zero
/* 1EFA4 800B43A4 18400073 */  blez       $v0, .L800B4574
/* 1EFA8 800B43A8 25080008 */   addiu     $t0, $t0, 0x8
/* 1EFAC 800B43AC 3C1E0C00 */  lui        $fp, (0xC000000 >> 16)
/* 1EFB0 800B43B0 00171C00 */  sll        $v1, $s7, 16
.L800B43B4:
/* 1EFB4 800B43B4 00031C03 */  sra        $v1, $v1, 16
...
/* 1EFCC 800B43CC 8E220000 */  lw         $v0, 0x0($s1)
/* 1EFD0 800B43D0 8E440018 */  lw         $a0, 0x18($s2)
/* 1EFD4 800B43D4 8E230004 */  lw         $v1, 0x4($s1)
...
/* 1F008 800B4408 00153400 */  sll        $a2, $s5, 16
/* 1F00C 800B440C 00063403 */  sra        $a2, $a2, 16
...
/* 1F104 800B4504 00143400 */  sll        $a2, $s4, 16
/* 1F108 800B4508 00063403 */  sra        $a2, $a2, 16
...
/* 1F128 800B4528 25080008 */  addiu      $t0, $t0, 0x8
/* 1F12C 800B452C 3063FFFF */  andi       $v1, $v1, 0xFFFF
/* 1F130 800B4530 007E1825 */  or         $v1, $v1, $fp
/* 1F134 800B4534 AC430000 */  sw         $v1, 0x0($v0)
/* 1F138 800B4538 00141C00 */  sll        $v1, $s4, 16
/* 1F13C 800B453C 34630930 */  ori        $v1, $v1, 0x930
/* 1F140 800B4540 AC430004 */  sw         $v1, 0x4($v0)
.L800B4544:
/* 1F144 800B4544 8E230004 */  lw         $v1, 0x4($s1)
/* 1F148 800B4548 8E440018 */  lw         $a0, 0x18($s2)
/* 1F14C 800B454C 26E20001 */  addiu      $v0, $s7, 0x1
...
/* 1F160 800B4560 00021400 */  sll        $v0, $v0, 16
/* 1F164 800B4564 00021403 */  sra        $v0, $v0, 16
/* 1F168 800B4568 0043102A */  slt        $v0, $v0, $v1
/* 1F16C 800B456C 1440FF91 */  bnez       $v0, .L800B43B4
/* 1F170 800B4570 00171C00 */   sll       $v1, $s7, 16
.L800B4574:
...
.L800B45A0:
/* 1F1A0 800B45A0 3C0507C0 */  lui        $a1, (0x7C00170 >> 16)
/* 1F1A4 800B45A4 34A50170 */  ori        $a1, $a1, (0x7C00170 & 0xFFFF)
/* 1F1A8 800B45A8 25020008 */  addiu      $v0, $t0, 0x8
/* 1F1AC 800B45AC 01002021 */  addu       $a0, $t0, $zero
/* 1F1B0 800B45B0 3C030A00 */  lui        $v1, (0xA000930 >> 16)
/* 1F1B4 800B45B4 34630930 */  ori        $v1, $v1, (0xA000930 & 0xFFFF)
/* 1F1B8 800B45B8 AC830000 */  sw         $v1, 0x0($a0)
/* 1F1BC 800B45BC AC850004 */  sw         $a1, 0x4($a0)
...
.size func_800B42E0, . - func_800B42E0
