...
/* 1F83C 800B4C3C 3C020B00 */  lui        $v0, (0xB000020 >> 16)
/* 1F840 800B4C40 34420020 */  ori        $v0, $v0, (0xB000020 & 0xFFFF)
/* 1F844 800B4C44 26440008 */  addiu      $a0, $s2, 0x8
...
/* 1F860 800B4C60 AE220000 */   sw        $v0, 0x0($s1)
/* 1F864 800B4C64 AE220004 */  sw         $v0, 0x4($s1)
/* 1F868 800B4C68 9242002F */  lbu        $v0, 0x2F($s2)
/* 1F86C 800B4C6C 96430002 */  lhu        $v1, 0x2($s2)
/* 1F870 800B4C70 3C040E00 */  lui        $a0, (0xE000000 >> 16)
/* 1F874 800B4C74 00021400 */  sll        $v0, $v0, 16
/* 1F878 800B4C78 00641825 */  or         $v1, $v1, $a0
/* 1F87C 800B4C7C 00431025 */  or         $v0, $v0, $v1
/* 1F880 800B4C80 AE220008 */  sw         $v0, 0x8($s1)
/* 1F884 800B4C84 8E440028 */  lw         $a0, 0x28($s2)
/* 1F888 800B4C88 0C02F680 */  jal        func_800BDA00
/* 1F88C 800B4C8C 00108600 */   sll       $s0, $s0, 24
/* 1F890 800B4C90 3C0400FF */  lui        $a0, (0xFFFFFF >> 16)
/* 1F894 800B4C94 3484FFFF */  ori        $a0, $a0, (0xFFFFFF & 0xFFFF)
...
.size func_800B4C30, . - func_800B4C30
