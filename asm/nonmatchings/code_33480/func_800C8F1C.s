...
/* 33B1C 800C8F1C 94A30000 */  lhu        $v1, 0x0($a1)
...
/* 33B38 800C8F38 A4800000 */  sh         $zero, 0x0($a0)
/* 33B3C 800C8F3C 94A20000 */  lhu        $v0, 0x0($a1)
/* 33B40 800C8F40 3042000F */  andi       $v0, $v0, 0xF
/* 33B44 800C8F44 14400019 */  bnez       $v0, .L800C8FAC
/* 33B48 800C8F48 24020002 */   addiu     $v0, $zero, 0x2
/* 33B4C 800C8F4C 94A20002 */  lhu        $v0, 0x2($a1)
/* 33B50 800C8F50 14400016 */  bnez       $v0, .L800C8FAC
/* 33B54 800C8F54 24020002 */   addiu     $v0, $zero, 0x2
/* 33B58 800C8F58 94A20004 */  lhu        $v0, 0x4($a1)
/* 33B5C 800C8F5C 14400013 */  bnez       $v0, .L800C8FAC
/* 33B60 800C8F60 24020002 */   addiu     $v0, $zero, 0x2
/* 33B64 800C8F64 94A20006 */  lhu        $v0, 0x6($a1)
/* 33B68 800C8F68 14400010 */  bnez       $v0, .L800C8FAC
/* 33B6C 800C8F6C 24020002 */   addiu     $v0, $zero, 0x2
/* 33B70 800C8F70 080323EB */  j          .L800C8FAC
/* 33B74 800C8F74 24020001 */   addiu     $v0, $zero, 0x1
.L800C8F78:
/* 33B78 800C8F78 18C00007 */  blez       $a2, .L800C8F98
/* 33B7C 800C8F7C 2402FFFF */   addiu     $v0, $zero, -0x1
/* 33B80 800C8F80 3063800F */  andi       $v1, $v1, 0x800F
/* 33B84 800C8F84 34633FF0 */  ori        $v1, $v1, 0x3FF0
/* 33B88 800C8F88 A5030000 */  sh         $v1, 0x0($t0)
/* 33B8C 800C8F8C 24E3FC02 */  addiu      $v1, $a3, -0x3FE
/* 33B90 800C8F90 080323EB */  j          .L800C8FAC
/* 33B94 800C8F94 A4830000 */   sh        $v1, 0x0($a0)
.L800C8F98:
/* 33B98 800C8F98 04C00003 */  bltz       $a2, .L800C8FA8
/* 33B9C 800C8F9C 00001021 */   addu      $v0, $zero, $zero
/* 33BA0 800C8FA0 080323EB */  j          .L800C8FAC
/* 33BA4 800C8FA4 A4800000 */   sh        $zero, 0x0($a0)
.L800C8FA8:
/* 33BA8 800C8FA8 24020002 */  addiu      $v0, $zero, 0x2
.L800C8FAC:
/* 33BAC 800C8FAC 03E00008 */  jr         $ra
/* 33BB0 800C8FB0 00000000 */   nop
.size func_800C8F1C, . - func_800C8F1C
