...
/* 1D714 800B2B14 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1D73C 800B2B3C AE130000 */  sw         $s3, 0x0($s0)
/* 1D740 800B2B40 92C2001C */  lbu        $v0, 0x1C($s6)
/* 1D744 800B2B44 2443FFFF */  addiu      $v1, $v0, -0x1
/* 1D748 800B2B48 2C620006 */  sltiu      $v0, $v1, 0x6
/* 1D74C 800B2B4C 10400017 */  beqz       $v0, .L800B2BAC
/* 1D750 800B2B50 00031080 */   sll       $v0, $v1, 2
/* 1D754 800B2B54 3C018010 */  lui        $at, %hi(jtbl_800FEB20)
/* 1D758 800B2B58 00220821 */  addu       $at, $at, $v0
/* 1D75C 800B2B5C 8C22EB20 */  lw         $v0, %lo(jtbl_800FEB20)($at)
...
/* 1D7E8 800B2BE8 24020002 */  addiu      $v0, $zero, 0x2
...
/* 1D804 800B2C04 24110002 */  addiu      $s1, $zero, 0x2
...
/* 1D828 800B2C28 A4400000 */  sh         $zero, 0x0($v0)
/* 1D82C 800B2C2C 8E63001C */  lw         $v1, 0x1C($s3)
/* 1D830 800B2C30 24840001 */  addiu      $a0, $a0, 0x1
...
/* 1D8C0 800B2CC0 8C430000 */  lw         $v1, 0x0($v0)
/* 1D8C4 800B2CC4 24A20003 */  addiu      $v0, $a1, 0x3
/* 1D8C8 800B2CC8 3042FFFF */  andi       $v0, $v0, 0xFFFF
/* 1D8CC 800B2CCC 00021080 */  sll        $v0, $v0, 2
/* 1D8D0 800B2CD0 00521021 */  addu       $v0, $v0, $s2
/* 1D8D4 800B2CD4 A6030008 */  sh         $v1, 0x8($s0)
/* 1D8D8 800B2CD8 8C420000 */  lw         $v0, 0x0($v0)
/* 1D8DC 800B2CDC 24B10004 */  addiu      $s1, $a1, 0x4
...
/* 1D8F0 800B2CF0 8C420000 */  lw         $v0, 0x0($v0)
...
/* 1D904 800B2D04 3C01447A */  lui        $at, (0x447A0000 >> 16)
/* 1D908 800B2D08 44811000 */  mtc1       $at, $f2
/* 1D90C 800B2D0C 00521021 */  addu       $v0, $v0, $s2
/* 1D910 800B2D10 C4400000 */  lwc1       $f0, 0x0($v0)
...
/* 1D930 800B2D30 8E040004 */  lw         $a0, 0x4($s0)
/* 1D934 800B2D34 8E030000 */  lw         $v1, 0x0($s0)
/* 1D938 800B2D38 24A20005 */  addiu      $v0, $a1, 0x5
/* 1D93C 800B2D3C 24B10006 */  addiu      $s1, $a1, 0x6
...
/* 1D96C 800B2D6C C4400000 */  lwc1       $f0, 0x0($v0)
...
/* 1D998 800B2D98 3C013F80 */  lui        $at, (0x3F800000 >> 16)
/* 1D99C 800B2D9C 44811000 */  mtc1       $at, $f2
/* 1D9A0 800B2DA0 02A03021 */  addu       $a2, $s5, $zero
/* 1D9A4 800B2DA4 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1D9D0 800B2DD0 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1DA2C 800B2E2C 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1DA48 800B2E48 24070001 */  addiu      $a3, $zero, 0x1
/* 1DA4C 800B2E4C AE020020 */  sw         $v0, 0x20($s0)
/* 1DA50 800B2E50 24020008 */  addiu      $v0, $zero, 0x8
...
.size func_800B2AF0, . - func_800B2AF0
