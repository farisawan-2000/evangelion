...
.L800C95B0:
/* 341B0 800C95B0 2401FFFF */  addiu      $at, $zero, -0x1
/* 341B4 800C95B4 14C10004 */  bne        $a2, $at, .L800C95C8
/* 341B8 800C95B8 3C018000 */   lui       $at, (0x80000000 >> 16)
...
/* 341DC 800C95DC 27BDFFF8 */  addiu      $sp, $sp, -0x8
/* 341E0 800C95E0 00803821 */  addu       $a3, $a0, $zero
/* 341E4 800C95E4 AFA30000 */  sw         $v1, 0x0($sp)
/* 341E8 800C95E8 00A22823 */  subu       $a1, $a1, $v0
/* 341EC 800C95EC 04610006 */  bgez       $v1, .L800C9608
/* 341F0 800C95F0 AFA50004 */   sw        $a1, 0x4($sp)
/* 341F4 800C95F4 18A00004 */  blez       $a1, .L800C9608
/* 341F8 800C95F8 24620001 */   addiu     $v0, $v1, 0x1
/* 341FC 800C95FC AFA20000 */  sw         $v0, 0x0($sp)
/* 34200 800C9600 00A61023 */  subu       $v0, $a1, $a2
/* 34204 800C9604 AFA20004 */  sw         $v0, 0x4($sp)
.L800C9608:
/* 34208 800C9608 8FA20000 */  lw         $v0, 0x0($sp)
/* 3420C 800C960C 8FA30004 */  lw         $v1, 0x4($sp)
/* 34210 800C9610 ACE20000 */  sw         $v0, 0x0($a3)
/* 34214 800C9614 ACE30004 */  sw         $v1, 0x4($a3)
/* 34218 800C9618 00E01021 */  addu       $v0, $a3, $zero
/* 3421C 800C961C 03E00008 */  jr         $ra
/* 34220 800C9620 27BD0008 */   addiu     $sp, $sp, 0x8
.size func_800C95A0, . - func_800C95A0
