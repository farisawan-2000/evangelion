...
/* 17D80 800AD180 00042400 */  sll        $a0, $a0, 16
/* 17D84 800AD184 00042403 */  sra        $a0, $a0, 16
...
/* 17DA4 800AD1A4 3C018010 */  lui        $at, %hi(jtbl_800FB3D8)
/* 17DA8 800AD1A8 00220821 */  addu       $at, $at, $v0
/* 17DAC 800AD1AC 8C22B3D8 */  lw         $v0, %lo(jtbl_800FB3D8)($at)
...
/* 17DC0 800AD1C0 24020001 */  addiu      $v0, $zero, 0x1
/* 17DC4 800AD1C4 10620007 */  beq        $v1, $v0, .L800AD1E4
/* 17DC8 800AD1C8 28620002 */   slti      $v0, $v1, 0x2
/* 17DCC 800AD1CC 14400027 */  bnez       $v0, .L800AD26C
/* 17DD0 800AD1D0 24020002 */   addiu     $v0, $zero, 0x2
...
.L800AD1E4:
/* 17DE4 800AD1E4 3C013F4C */  lui        $at, (0x3F4CCCCD >> 16)
/* 17DE8 800AD1E8 3421CCCD */  ori        $at, $at, (0x3F4CCCCD & 0xFFFF)
...
.L800AD1FC:
/* 17DFC 800AD1FC 3C013F33 */  lui        $at, (0x3F333333 >> 16)
/* 17E00 800AD200 34213333 */  ori        $at, $at, (0x3F333333 & 0xFFFF)
...
/* 17E1C 800AD21C 24020001 */  addiu      $v0, $zero, 0x1
/* 17E20 800AD220 10620007 */  beq        $v1, $v0, .L800AD240
/* 17E24 800AD224 28620002 */   slti      $v0, $v1, 0x2
/* 17E28 800AD228 14400010 */  bnez       $v0, .L800AD26C
/* 17E2C 800AD22C 24020002 */   addiu     $v0, $zero, 0x2
...
.L800AD240:
/* 17E40 800AD240 3C013F99 */  lui        $at, (0x3F99999A >> 16)
/* 17E44 800AD244 3421999A */  ori        $at, $at, (0x3F99999A & 0xFFFF)
...
.L800AD258:
/* 17E58 800AD258 3C013FB3 */  lui        $at, (0x3FB33333 >> 16)
/* 17E5C 800AD25C 34213333 */  ori        $at, $at, (0x3FB33333 & 0xFFFF)
...
.size func_800AD180, . - func_800AD180
