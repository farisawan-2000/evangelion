...
/* 13A54 800A8E54 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13A58 800A8E58 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
...
/* 13A84 800A8E84 24420001 */  addiu      $v0, $v0, 0x1
...
/* 13AA4 800A8EA4 24040001 */   addiu     $a0, $zero, 0x1
...
/* 13AB8 800A8EB8 3C038015 */  lui        $v1, %hi(gDisplayListHead)
/* 13ABC 800A8EBC 8C639F94 */  lw         $v1, %lo(gDisplayListHead)($v1)
/* 13AC0 800A8EC0 24620008 */  addiu      $v0, $v1, 0x8
/* 13AC4 800A8EC4 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13AC8 800A8EC8 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13ACC 800A8ECC 3C02E900 */  lui        $v0, (0xE9000000 >> 16)
/* 13AD0 800A8ED0 24640010 */  addiu      $a0, $v1, 0x10
/* 13AD4 800A8ED4 AC620000 */  sw         $v0, 0x0($v1)
/* 13AD8 800A8ED8 3C02DF00 */  lui        $v0, (0xDF000000 >> 16)
/* 13ADC 800A8EDC AC600004 */  sw         $zero, 0x4($v1)
/* 13AE0 800A8EE0 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13AE4 800A8EE4 AC249F94 */  sw         $a0, %lo(gDisplayListHead)($at)
/* 13AE8 800A8EE8 AC620008 */  sw         $v0, 0x8($v1)
...
.size func_800A8E40, . - func_800A8E40
