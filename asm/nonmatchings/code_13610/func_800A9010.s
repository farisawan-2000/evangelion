...
/* 13C20 800A9020 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13C24 800A9024 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
...
/* 13C3C 800A903C 24040002 */   addiu     $a0, $zero, 0x2
/* 13C40 800A9040 3C038015 */  lui        $v1, %hi(gDisplayListHead)
/* 13C44 800A9044 8C639F94 */  lw         $v1, %lo(gDisplayListHead)($v1)
/* 13C48 800A9048 24620008 */  addiu      $v0, $v1, 0x8
/* 13C4C 800A904C 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13C50 800A9050 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13C54 800A9054 3C02E900 */  lui        $v0, (0xE9000000 >> 16)
/* 13C58 800A9058 24640010 */  addiu      $a0, $v1, 0x10
/* 13C5C 800A905C AC620000 */  sw         $v0, 0x0($v1)
/* 13C60 800A9060 3C02DF00 */  lui        $v0, (0xDF000000 >> 16)
/* 13C64 800A9064 AC600004 */  sw         $zero, 0x4($v1)
/* 13C68 800A9068 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13C6C 800A906C AC249F94 */  sw         $a0, %lo(gDisplayListHead)($at)
/* 13C70 800A9070 AC620008 */  sw         $v0, 0x8($v1)
...
.size func_800A9010, . - func_800A9010
