...
/* 13B2C 800A8F2C 3C11E900 */   lui       $s1, (0xE9000000 >> 16)
/* 13B30 800A8F30 0C02A601 */  jal        func_800A9804
/* 13B34 800A8F34 3C10DF00 */   lui       $s0, (0xDF000000 >> 16)
/* 13B38 800A8F38 3C028010 */  lui        $v0, %hi(D_801001D0)
/* 13B3C 800A8F3C 8C4201D0 */  lw         $v0, %lo(D_801001D0)($v0)
/* 13B40 800A8F40 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13B44 800A8F44 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
...
/* 13B58 800A8F58 3C038015 */  lui        $v1, %hi(gDisplayListHead)
/* 13B5C 800A8F5C 8C639F94 */  lw         $v1, %lo(gDisplayListHead)($v1)
/* 13B60 800A8F60 24620008 */  addiu      $v0, $v1, 0x8
/* 13B64 800A8F64 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13B68 800A8F68 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13B6C 800A8F6C 24620010 */  addiu      $v0, $v1, 0x10
/* 13B70 800A8F70 AC710000 */  sw         $s1, 0x0($v1)
/* 13B74 800A8F74 AC600004 */  sw         $zero, 0x4($v1)
/* 13B78 800A8F78 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13B7C 800A8F7C AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13B80 800A8F80 AC700008 */  sw         $s0, 0x8($v1)
...
/* 13B98 800A8F98 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13B9C 800A8F9C AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
...
/* 13BAC 800A8FAC 24040001 */   addiu     $a0, $zero, 0x1
/* 13BB0 800A8FB0 3C038015 */  lui        $v1, %hi(gDisplayListHead)
/* 13BB4 800A8FB4 8C639F94 */  lw         $v1, %lo(gDisplayListHead)($v1)
/* 13BB8 800A8FB8 24620008 */  addiu      $v0, $v1, 0x8
/* 13BBC 800A8FBC 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13BC0 800A8FC0 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13BC4 800A8FC4 24620010 */  addiu      $v0, $v1, 0x10
/* 13BC8 800A8FC8 AC710000 */  sw         $s1, 0x0($v1)
/* 13BCC 800A8FCC AC600004 */  sw         $zero, 0x4($v1)
/* 13BD0 800A8FD0 3C018015 */  lui        $at, %hi(gDisplayListHead)
/* 13BD4 800A8FD4 AC229F94 */  sw         $v0, %lo(gDisplayListHead)($at)
/* 13BD8 800A8FD8 AC700008 */  sw         $s0, 0x8($v1)
...
.size func_800A8F14, . - func_800A8F14
