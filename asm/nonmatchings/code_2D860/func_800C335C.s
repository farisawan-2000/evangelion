...
/* 2DF5C 800C335C 24020001 */  addiu      $v0, $zero, 0x1
...
/* 2DFE4 800C33E4 240C0003 */  addiu      $t4, $zero, 0x3
/* 2DFE8 800C33E8 00041040 */  sll        $v0, $a0, 1
/* 2DFEC 800C33EC 00454821 */  addu       $t1, $v0, $a1
.L800C33F0:
/* 2DFF0 800C33F0 95220000 */  lhu        $v0, 0x0($t1)
/* 2DFF4 800C33F4 144C0008 */  bne        $v0, $t4, .L800C3418
/* 2DFF8 800C33F8 00081040 */   sll       $v0, $t0, 1
/* 2DFFC 800C33FC 00A21021 */  addu       $v0, $a1, $v0
/* 2E000 800C3400 A04B0000 */  sb         $t3, 0x0($v0)
/* 2E004 800C3404 A0440001 */  sb         $a0, 0x1($v0)
/* 2E008 800C3408 8D420000 */  lw         $v0, 0x0($t2)
/* 2E00C 800C340C 00804021 */  addu       $t0, $a0, $zero
/* 2E010 800C3410 24420001 */  addiu      $v0, $v0, 0x1
/* 2E014 800C3414 AD420000 */  sw         $v0, 0x0($t2)
.L800C3418:
/* 2E018 800C3418 8D430000 */  lw         $v1, 0x0($t2)
/* 2E01C 800C341C 24840001 */  addiu      $a0, $a0, 0x1
...
/* 2E030 800C3430 25290002 */   addiu     $t1, $t1, 0x2
.L800C3434:
/* 2E034 800C3434 24020080 */  addiu      $v0, $zero, 0x80
/* 2E038 800C3438 14820007 */  bne        $a0, $v0, .L800C3458
/* 2E03C 800C343C ACED0000 */   sw        $t5, 0x0($a3)
/* 2E040 800C3440 8D420000 */  lw         $v0, 0x0($t2)
...
/* 2E054 800C3454 ADC80000 */   sw        $t0, 0x0($t6)
.L800C3458:
/* 2E058 800C3458 00081040 */  sll        $v0, $t0, 1
.L800C345C:
/* 2E05C 800C345C 00A21021 */  addu       $v0, $a1, $v0
/* 2E060 800C3460 24030001 */  addiu      $v1, $zero, 0x1
/* 2E064 800C3464 A4430000 */  sh         $v1, 0x0($v0)
/* 2E068 800C3468 ADC00000 */  sw         $zero, 0x0($t6)
.L800C346C:
...
.size func_800C335C, . - func_800C335C
