...
/* 327E0 800C7BE0 0C0319D0 */  jal        __osDisableInt
/* 327E4 800C7BE4 AFB10014 */   sw        $s1, 0x14($sp)
/* 327E8 800C7BE8 16000004 */  bnez       $s0, .L800C7BFC
/* 327EC 800C7BEC 00408821 */   addu      $s1, $v0, $zero
/* 327F0 800C7BF0 3C10800F */  lui        $s0, %hi(__osRunningThread)
/* 327F4 800C7BF4 08031F06 */  j          .L800C7C18
/* 327F8 800C7BF8 8E1069C0 */   lw        $s0, %lo(__osRunningThread)($s0)
.L800C7BFC:
/* 327FC 800C7BFC 96030010 */  lhu        $v1, %lo(D_800F0010)($s0)
/* 32800 800C7C00 24020001 */  addiu      $v0, $zero, 0x1
/* 32804 800C7C04 10620004 */  beq        $v1, $v0, .L800C7C18
/* 32808 800C7C08 00000000 */   nop
/* 3280C 800C7C0C 8E040008 */  lw         $a0, %lo(D_800F0008)($s0)
/* 32810 800C7C10 0C030744 */  jal        func_800C1D10
/* 32814 800C7C14 02002821 */   addu      $a1, $s0, $zero
.L800C7C18:
/* 32818 800C7C18 3C02800F */  lui        $v0, %hi(__osActiveQueue)
/* 3281C 800C7C1C 8C4269BC */  lw         $v0, %lo(__osActiveQueue)($v0)
/* 32820 800C7C20 14500008 */  bne        $v0, $s0, .L800C7C44
/* 32824 800C7C24 00402021 */   addu      $a0, $v0, $zero
/* 32828 800C7C28 8E02000C */  lw         $v0, 0xC($s0)
/* 3282C 800C7C2C 3C01800F */  lui        $at, %hi(__osActiveQueue)
/* 32830 800C7C30 08031F1D */  j          .L800C7C74
/* 32834 800C7C34 AC2269BC */   sw        $v0, %lo(__osActiveQueue)($at)
.L800C7C38:
/* 32838 800C7C38 8E02000C */  lw         $v0, %lo(D_800F000C)($s0)
/* 3283C 800C7C3C 08031F1D */  j          .L800C7C74
/* 32840 800C7C40 AC82000C */   sw        $v0, 0xC($a0)
.L800C7C44:
/* 32844 800C7C44 8C830004 */  lw         $v1, 0x4($a0)
/* 32848 800C7C48 2402FFFF */  addiu      $v0, $zero, -0x1
/* 3284C 800C7C4C 10620009 */  beq        $v1, $v0, .L800C7C74
/* 32850 800C7C50 00000000 */   nop
/* 32854 800C7C54 2403FFFF */  addiu      $v1, $zero, -0x1
.L800C7C58:
...
/* 32868 800C7C68 8C820004 */  lw         $v0, 0x4($a0)
/* 3286C 800C7C6C 1443FFFA */  bne        $v0, $v1, .L800C7C58
/* 32870 800C7C70 00000000 */   nop
.L800C7C74:
/* 32874 800C7C74 3C02800F */  lui        $v0, %hi(__osRunningThread)
/* 32878 800C7C78 8C4269C0 */  lw         $v0, %lo(__osRunningThread)($v0)
/* 3287C 800C7C7C 16020003 */  bne        $s0, $v0, .L800C7C8C
/* 32880 800C7C80 00000000 */   nop
/* 32884 800C7C84 0C03196B */  jal        __osDispatchThread
/* 32888 800C7C88 00000000 */   nop
.L800C7C8C:
/* 3288C 800C7C8C 0C0319EC */  jal        __osRestoreInt
...
.size func_800C7BD0, . - func_800C7BD0
