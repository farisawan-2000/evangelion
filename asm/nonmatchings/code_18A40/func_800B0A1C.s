...
.L800B0A68:
/* 1B668 800B0A68 8C620000 */  lw         $v0, 0x0($v1)
/* 1B66C 800B0A6C 10400003 */  beqz       $v0, .L800B0A7C
/* 1B670 800B0A70 24840001 */   addiu     $a0, $a0, 0x1
/* 1B674 800B0A74 00451021 */  addu       $v0, $v0, $a1
/* 1B678 800B0A78 AC620000 */  sw         $v0, 0x0($v1)
.L800B0A7C:
/* 1B67C 800B0A7C 28820007 */  slti       $v0, $a0, 0x7
/* 1B680 800B0A80 1440FFF9 */  bnez       $v0, .L800B0A68
/* 1B684 800B0A84 24630004 */   addiu     $v1, $v1, 0x4
...
/* 1B730 800B0B30 2405FFFF */  addiu      $a1, $zero, -0x1
/* 1B734 800B0B34 24620001 */  addiu      $v0, $v1, 0x1
...
/* 1B770 800B0B70 8E030000 */  lw         $v1, 0x0($s0)
/* 1B774 800B0B74 24020001 */  addiu      $v0, $zero, 0x1
/* 1B778 800B0B78 A20200D2 */  sb         $v0, 0xD2($s0)
/* 1B77C 800B0B7C AE120074 */  sw         $s2, 0x74($s0)
/* 1B780 800B0B80 34630003 */  ori        $v1, $v1, 0x3
/* 1B784 800B0B84 AE030000 */  sw         $v1, 0x0($s0)
...
/* 1B820 800B0C20 8C420000 */  lw         $v0, 0x0($v0)
...
/* 1B834 800B0C34 8C420000 */  lw         $v0, 0x0($v0)
/* 1B838 800B0C38 AE150044 */  sw         $s5, 0x44($s0)
/* 1B83C 800B0C3C AE020080 */  sw         $v0, 0x80($s0)
/* 1B840 800B0C40 AE020004 */  sw         $v0, 0x4($s0)
/* 1B844 800B0C44 26730001 */  addiu      $s3, $s3, 0x1
.L800B0C48:
...
.size func_800B0A1C, . - func_800B0A1C
