...
/* 1CDD0 800B21D0 3C03FF00 */  lui        $v1, (0xFF000000 >> 16)
...
/* 1CDEC 800B21EC 3C0200FF */  lui        $v0, (0xFFFFFF >> 16)
/* 1CDF0 800B21F0 3442FFFF */  ori        $v0, $v0, (0xFFFFFF & 0xFFFF)
/* 1CDF4 800B21F4 00822024 */  and        $a0, $a0, $v0
/* 1CDF8 800B21F8 3C020014 */  lui        $v0, (0x140000 >> 16)
...
/* 1CE0C 800B220C 30420001 */  andi       $v0, $v0, 0x1
...
/* 1CE58 800B2258 8CC60004 */  lw         $a2, 0x4($a2)
...
.L800B2280:
/* 1CE80 800B2280 8E020004 */  lw         $v0, 0x4($s0)
...
/* 1CE90 800B2290 8CE20004 */  lw         $v0, 0x4($a3)
/* 1CE94 800B2294 10400002 */  beqz       $v0, .L800B22A0
/* 1CE98 800B2298 AE020004 */   sw        $v0, 0x4($s0)
/* 1CE9C 800B229C AC500000 */  sw         $s0, 0x0($v0)
.L800B22A0:
/* 1CEA0 800B22A0 AE070000 */  sw         $a3, 0x0($s0)
/* 1CEA4 800B22A4 0802C8B7 */  j          .L800B22DC
/* 1CEA8 800B22A8 ACF00004 */   sw        $s0, 0x4($a3)
.L800B22AC:
/* 1CEAC 800B22AC 24020002 */  addiu      $v0, $zero, 0x2
/* 1CEB0 800B22B0 ACC20008 */  sw         $v0, 0x8($a2)
...
/* 1CEC4 800B22C4 AE000000 */  sw         $zero, 0x0($s0)
/* 1CEC8 800B22C8 10400002 */  beqz       $v0, .L800B22D4
/* 1CECC 800B22CC AE020004 */   sw        $v0, 0x4($s0)
/* 1CED0 800B22D0 AC500000 */  sw         $s0, 0x0($v0)
.L800B22D4:
...
/* 1CEEC 800B22EC 2402FFFE */  addiu      $v0, $zero, -0x2
/* 1CEF0 800B22F0 00821024 */  and        $v0, $a0, $v0
/* 1CEF4 800B22F4 AE02000C */  sw         $v0, 0xC($s0)
/* 1CEF8 800B22F8 24020002 */  addiu      $v0, $zero, 0x2
/* 1CEFC 800B22FC AE020008 */  sw         $v0, 0x8($s0)
/* 1CF00 800B2300 24620001 */  addiu      $v0, $v1, 0x1
...
/* 1CF24 800B2324 A0A00002 */  sb         $zero, 0x2($a1)
/* 1CF28 800B2328 ACA20004 */  sw         $v0, 0x4($a1)
/* 1CF2C 800B232C 8E020010 */  lw         $v0, 0x10($s0)
/* 1CF30 800B2330 ACA20008 */  sw         $v0, 0x8($a1)
...
.size func_800B21CC, . - func_800B21CC
