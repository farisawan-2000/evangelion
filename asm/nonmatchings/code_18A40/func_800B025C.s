...
/* 1AE84 800B0284 3C038000 */   lui       $v1, (0x80000000 >> 16)
/* 1AE88 800B0288 26040024 */  addiu      $a0, $s0, 0x24
/* 1AE8C 800B028C 02002821 */  addu       $a1, $s0, $zero
/* 1AE90 800B0290 24060003 */  addiu      $a2, $zero, 0x3
...
/* 1AEC4 800B02C4 3C07FF00 */  lui        $a3, (0xFF000000 >> 16)
/* 1AEC8 800B02C8 24080001 */  addiu      $t0, $zero, 0x1
/* 1AECC 800B02CC 00002821 */  addu       $a1, $zero, $zero
.L800B02D0:
/* 1AED0 800B02D0 8E020028 */  lw         $v0, 0x28($s0)
/* 1AED4 800B02D4 00452021 */  addu       $a0, $v0, $a1
/* 1AED8 800B02D8 90830000 */  lbu        $v1, 0x0($a0)
...
/* 1AF04 800B0304 E4800000 */  swc1       $f0, 0x0($a0)
/* 1AF08 800B0308 8E020024 */  lw         $v0, 0x24($s0)
/* 1AF0C 800B030C 00461021 */  addu       $v0, $v0, $a2
/* 1AF10 800B0310 90420000 */  lbu        $v0, 0x0($v0)
...
/* 1AFA4 800B03A4 8C430000 */  lw         $v1, 0x0($v0)
/* 1AFA8 800B03A8 90620008 */  lbu        $v0, 0x8($v1)
...
/* 1AFC4 800B03C4 24C60001 */  addiu      $a2, $a2, 0x1
/* 1AFC8 800B03C8 00C2102A */  slt        $v0, $a2, $v0
/* 1AFCC 800B03CC 1440FFC0 */  bnez       $v0, .L800B02D0
/* 1AFD0 800B03D0 24A50004 */   addiu     $a1, $a1, 0x4
.L800B03D4:
...
.size func_800B025C, . - func_800B025C
