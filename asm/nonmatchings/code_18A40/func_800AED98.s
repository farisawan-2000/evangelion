...
/* 1999C 800AED9C 27BDFFF8 */   addiu     $sp, $sp, -0x8
...
/* 199C8 800AEDC8 24A50001 */   addiu     $a1, $a1, 0x1
/* 199CC 800AEDCC 8C62FFFC */  lw         $v0, -0x4($v1)
/* 199D0 800AEDD0 14400002 */  bnez       $v0, .L800AEDDC
/* 199D4 800AEDD4 00000000 */   nop
/* 199D8 800AEDD8 8C620000 */  lw         $v0, 0x0($v1)
.L800AEDDC:
/* 199DC 800AEDDC 0802BB7D */  j          .L800AEDF4
/* 199E0 800AEDE0 8C420008 */   lw        $v0, 0x8($v0)
.L800AEDE4:
...
/* 199F8 800AEDF8 27BD0008 */   addiu     $sp, $sp, 0x8
.size func_800AED98, . - func_800AED98
