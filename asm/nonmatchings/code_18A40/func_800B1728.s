...
/* 1C350 800B1750 AC600000 */  sw         $zero, 0x0($v1)
/* 1C354 800B1754 8E420004 */  lw         $v0, 0x4($s2)
...
/* 1C370 800B1770 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1C384 800B1784 24020001 */  addiu      $v0, $zero, 0x1
...
/* 1C3F4 800B17F4 24070001 */  addiu      $a3, $zero, 0x1
...
/* 1C444 800B1844 3C02800B */  lui        $v0, %hi(func_800B42E0)
/* 1C448 800B1848 244242E0 */  addiu      $v0, $v0, %lo(func_800B42E0)
/* 1C44C 800B184C 0802C618 */  j          .L800B1860
/* 1C450 800B1850 AC620004 */   sw        $v0, 0x4($v1)
.L800B1854:
/* 1C454 800B1854 3C02800B */  lui        $v0, %hi(func_800B2A50)
/* 1C458 800B1858 24422A50 */  addiu      $v0, $v0, %lo(func_800B2A50)
/* 1C45C 800B185C AC820004 */  sw         $v0, 0x4($a0)
.L800B1860:
...
/* 1C46C 800B186C AC400004 */  sw         $zero, 0x4($v0)
/* 1C470 800B1870 AC400008 */  sw         $zero, 0x8($v0)
...
/* 1C48C 800B188C 8E470004 */  lw         $a3, 0x4($s2)
...
/* 1C49C 800B189C 8E430004 */  lw         $v1, 0x4($s2)
...
/* 1C4F0 800B18F0 24620001 */  addiu      $v0, $v1, 0x1
/* 1C4F4 800B18F4 00031880 */  sll        $v1, $v1, 2
/* 1C4F8 800B18F8 00651821 */  addu       $v1, $v1, $a1
/* 1C4FC 800B18FC AC820014 */  sw         $v0, 0x14($a0)
/* 1C500 800B1900 AC710000 */  sw         $s1, 0x0($v1)
/* 1C504 800B1904 8E420004 */  lw         $v0, 0x4($s2)
/* 1C508 800B1908 26100001 */  addiu      $s0, $s0, 0x1
...
/* 1C524 800B1924 8E470008 */  lw         $a3, 0x8($s2)
...
/* 1C540 800B1940 8E430008 */  lw         $v1, 0x8($s2)
...
/* 1C554 800B1954 AC620000 */  sw         $v0, 0x0($v1)
/* 1C558 800B1958 AC83002C */  sw         $v1, 0x2C($a0)
/* 1C55C 800B195C 8E420008 */  lw         $v0, 0x8($s2)
/* 1C560 800B1960 26100001 */  addiu      $s0, $s0, 0x1
...
.size func_800B1728, . - func_800B1728
