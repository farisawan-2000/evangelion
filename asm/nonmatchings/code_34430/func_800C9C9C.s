...
/* 348AC 800C9CAC 2401FFFF */  addiu      $at, $zero, -0x1
...
/* 34930 800C9D30 54200010 */  bnel       $at, $zero, .L800C9D74
/* 34934 800C9D34 8C620000 */   lw        $v0, 0x0($v1)
/* 34938 800C9D38 8C620004 */  lw         $v0, 0x4($v1)
...
/* 34950 800C9D50 54200004 */  bnel       $at, $zero, .L800C9D64
/* 34954 800C9D54 00804825 */   or        $t1, $a0, $zero
/* 34958 800C9D58 54A00006 */  bnel       $a1, $zero, .L800C9D74
/* 3495C 800C9D5C 8C620000 */   lw        $v0, 0x0($v1)
/* 34960 800C9D60 00804825 */  or         $t1, $a0, $zero
.L800C9D64:
/* 34964 800C9D64 00603825 */  or         $a3, $v1, $zero
/* 34968 800C9D68 00402825 */  or         $a1, $v0, $zero
/* 3496C 800C9D6C 8C680000 */  lw         $t0, 0x0($v1)
.L800C9D70:
/* 34970 800C9D70 8C620000 */  lw         $v0, 0x0($v1)
.L800C9D74:
...
.L800C9DB8:
/* 349B8 800C9DB8 8C620000 */  lw         $v0, 0x0($v1)
...
/* 34A10 800C9E10 ACEF0000 */  sw         $t7, 0x0($a3)
/* 34A14 800C9E14 ACEC0004 */  sw         $t4, 0x4($a3)
/* 34A18 800C9E18 ACE00008 */  sw         $zero, 0x8($a3)
.L800C9E1C:
...
/* 34A34 800C9E34 240E0001 */  addiu      $t6, $zero, 0x1
/* 34A38 800C9E38 0127C823 */  subu       $t9, $t1, $a3
/* 34A3C 800C9E3C AC620000 */  sw         $v0, 0x0($v1)
/* 34A40 800C9E40 AC700004 */  sw         $s0, 0x4($v1)
/* 34A44 800C9E44 AC6E0008 */  sw         $t6, 0x8($v1)
...
/* 34A58 800C9E58 AC480000 */  sw         $t0, 0x0($v0)
/* 34A5C 800C9E5C AC4C0004 */  sw         $t4, 0x4($v0)
/* 34A60 800C9E60 AC400008 */  sw         $zero, 0x8($v0)
...
/* 34A74 800C9E74 24190001 */  addiu      $t9, $zero, 0x1
/* 34A78 800C9E78 AC680000 */  sw         $t0, 0x0($v1)
/* 34A7C 800C9E7C AC6E0004 */  sw         $t6, 0x4($v1)
/* 34A80 800C9E80 AC790008 */  sw         $t9, 0x8($v1)
...
.size func_800C9C9C, . - func_800C9C9C
