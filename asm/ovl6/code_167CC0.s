...
/* 167CC0 8003DF60 3C028005 */  lui        $v0, %hi(D_8004AD52_174AB2)
/* 167CC4 8003DF64 9042AD52 */  lbu        $v0, %lo(D_8004AD52_174AB2)($v0)
...
/* 167D38 8003DFD8 3C018005 */  lui        $at, %hi(D_8004AD52_174AB2)
/* 167D3C 8003DFDC A020AD52 */  sb         $zero, %lo(D_8004AD52_174AB2)($at)
.L8003DFE0:
...
/* 167D7C 8003E01C 3C018005 */  lui        $at, %hi(D_8004AD52_174AB2)
/* 167D80 8003E020 0C00D18F */  jal        func_8003463C_15E39C
/* 167D84 8003E024 A022AD52 */   sb        $v0, %lo(D_8004AD52_174AB2)($at)
...
/* 167DC8 8003E068 3C108004 */  lui        $s0, %hi(D_8004231C_16C07C)
/* 167DCC 8003E06C 2610231C */  addiu      $s0, $s0, %lo(D_8004231C_16C07C)
...
/* 167E10 8003E0B0 3C018005 */  lui        $at, %hi(D_8004AD50_174AB0)
/* 167E14 8003E0B4 A020AD50 */  sb         $zero, %lo(D_8004AD50_174AB0)($at)
/* 167E18 8003E0B8 3C018005 */  lui        $at, %hi(D_8004AD51_174AB1)
/* 167E1C 8003E0BC A020AD51 */  sb         $zero, %lo(D_8004AD51_174AB1)($at)
...
/* 167E4C 8003E0EC 3C068005 */  lui        $a2, %hi(D_8004B8D8_175638)
/* 167E50 8003E0F0 24C6B8D8 */  addiu      $a2, $a2, %lo(D_8004B8D8_175638)
...
/* 167E70 8003E110 3C0C8005 */  lui        $t4, %hi(D_8004B8DC_17563C)
/* 167E74 8003E114 258CB8DC */  addiu      $t4, $t4, %lo(D_8004B8DC_17563C)
...
.L8003E12C:
/* 167E8C 8003E12C 3C068005 */  lui        $a2, %hi(D_8004AD51_174AB1)
/* 167E90 8003E130 90C6AD51 */  lbu        $a2, %lo(D_8004AD51_174AB1)($a2)
...
/* 167F00 8003E1A0 3C028005 */  lui        $v0, %hi(D_8004AD51_174AB1)
/* 167F04 8003E1A4 9042AD51 */  lbu        $v0, %lo(D_8004AD51_174AB1)($v0)
/* 167F08 8003E1A8 10400003 */  beqz       $v0, .L8003E1B8
/* 167F0C 8003E1AC 2442FFFF */   addiu     $v0, $v0, -1
/* 167F10 8003E1B0 3C018005 */  lui        $at, %hi(D_8004AD51_174AB1)
/* 167F14 8003E1B4 A022AD51 */  sb         $v0, %lo(D_8004AD51_174AB1)($at)
.L8003E1B8:
...
/* 167FF0 8003E290 3C028005 */  lui        $v0, %hi(D_8004AD60_174AC0)
/* 167FF4 8003E294 9042AD60 */  lbu        $v0, %lo(D_8004AD60_174AC0)($v0)
...
/* 168018 8003E2B8 3C038005 */  lui        $v1, %hi(D_8004AD61_174AC1)
/* 16801C 8003E2BC 9063AD61 */  lbu        $v1, %lo(D_8004AD61_174AC1)($v1)
...
/* 1680E0 8003E380 3C018005 */  lui        $at, %hi(D_8004AAE4_174844)
/* 1680E4 8003E384 0C00D112 */  jal        func_80034448_15E1A8
/* 1680E8 8003E388 AC22AAE4 */   sw        $v0, %lo(D_8004AAE4_174844)($at)
/* 1680EC 8003E38C 3C018005 */  lui        $at, %hi(D_8004BEE0)
/* 1680F0 8003E390 AC22BEE0 */  sw         $v0, %lo(D_8004BEE0)($at)
/* 1680F4 8003E394 3C018005 */  lui        $at, %hi(D_8004AD61_174AC1)
/* 1680F8 8003E398 A020AD61 */  sb         $zero, %lo(D_8004AD61_174AC1)($at)
/* 1680FC 8003E39C 3C018005 */  lui        $at, %hi(D_8004AD60_174AC0)
/* 168100 8003E3A0 A020AD60 */  sb         $zero, %lo(D_8004AD60_174AC0)($at)
.L8003E3A4:
...
/* 168140 8003E3E0 3C018005 */  lui        $at, %hi(D_8004AD60_174AC0)
/* 168144 8003E3E4 A031AD60 */  sb         $s1, %lo(D_8004AD60_174AC0)($at)
...
/* 168180 8003E420 3C018005 */  lui        $at, %hi(D_8004AD61_174AC1)
/* 168184 8003E424 0C00A638 */  jal        func_800298E0_153640
/* 168188 8003E428 A031AD61 */   sb        $s1, %lo(D_8004AD61_174AC1)($at)
