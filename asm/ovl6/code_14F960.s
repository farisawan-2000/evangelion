...
/* 14F960 80025C00 3C038004 */  lui        $v1, %hi(func_80041130 + 0x70)
/* 14F964 80025C04 906311A0 */  lbu        $v1, %lo(func_80041130 + 0x70)($v1)
...
/* 14F984 80025C24 3C018005 */  lui        $at, %hi(jtbl_8004AEC0)
/* 14F988 80025C28 00220821 */  addu       $at, $at, $v0
/* 14F98C 80025C2C 8C22AEC0 */  lw         $v0, %lo(jtbl_8004AEC0)($at)
glabel .L80025C30
...
/* 14F9A4 80025C44 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
/* 14F9A8 80025C48 A02211A0 */  sb         $v0, %lo(func_80041130 + 0x70)($at)
...
/* 14F9DC 80025C7C 3C048004 */  lui        $a0, %hi(func_80041130 + 0x4C)
/* 14F9E0 80025C80 0C027448 */  jal        func_8009D120
/* 14F9E4 80025C84 2484117C */   addiu     $a0, $a0, %lo(func_80041130 + 0x4C)
...
/* 14FA0C 80025CAC 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
glabel .L80025CB0
/* 14FA10 80025CB0 A02211A0 */  sb         $v0, %lo(func_80041130 + 0x70)($at)
glabel .L80025CB4
/* 14FA14 80025CB4 3C118004 */  lui        $s1, %hi(func_80041130 + 0x68)
/* 14FA18 80025CB8 8E311198 */  lw         $s1, %lo(func_80041130 + 0x68)($s1)
...
/* 14FB30 80025DD0 3C028004 */  lui        $v0, %hi(func_80041060 + 0x10)
/* 14FB34 80025DD4 8C421070 */  lw         $v0, %lo(func_80041060 + 0x10)($v0)
/* 14FB38 80025DD8 2442FFFF */  addiu      $v0, $v0, -0x1
.L80025DDC:
/* 14FB3C 80025DDC 3C018004 */  lui        $at, %hi(func_80041060 + 0x10)
.L80025DE0:
/* 14FB40 80025DE0 AC221070 */  sw         $v0, %lo(func_80041060 + 0x10)($at)
/* 14FB44 80025DE4 30620001 */  andi       $v0, $v1, 0x1
.L80025DE8:
/* 14FB48 80025DE8 10400006 */  beqz       $v0, .L80025E04
/* 14FB4C 80025DEC 00000000 */   nop
/* 14FB50 80025DF0 3C028004 */  lui        $v0, %hi(func_80041060 + 0x10)
/* 14FB54 80025DF4 8C421070 */  lw         $v0, %lo(func_80041060 + 0x10)($v0)
/* 14FB58 80025DF8 24420001 */  addiu      $v0, $v0, 0x1
/* 14FB5C 80025DFC 3C018004 */  lui        $at, %hi(func_80041060 + 0x10)
.L80025E00:
/* 14FB60 80025E00 AC221070 */  sw         $v0, %lo(func_80041060 + 0x10)($at)
.L80025E04:
/* 14FB64 80025E04 3C068004 */  lui        $a2, %hi(func_80041060 + 0x10)
.L80025E08:
/* 14FB68 80025E08 8CC61070 */  lw         $a2, %lo(func_80041060 + 0x10)($a2)
.L80025E0C:
...
/* 14FBAC 80025E4C 3C058004 */  lui        $a1, %hi(func_80041060 + 0x10)
/* 14FBB0 80025E50 8CA51070 */  lw         $a1, %lo(func_80041060 + 0x10)($a1)
...
.L80025E6C:
/* 14FBCC 80025E6C 3C048004 */  lui        $a0, %hi(func_80041060 + 0x10)
/* 14FBD0 80025E70 8C841070 */  lw         $a0, %lo(func_80041060 + 0x10)($a0)
...
glabel .L80025EB8
/* 14FC18 80025EB8 3C048004 */  lui        $a0, %hi(func_80041130 + 0x4C)
/* 14FC1C 80025EBC 2484117C */  addiu      $a0, $a0, %lo(func_80041130 + 0x4C)
.L80025EC0:
...
/* 14FC64 80025F04 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
/* 14FC68 80025F08 A02211A0 */  sb         $v0, %lo(func_80041130 + 0x70)($at)
.L80025F0C:
/* 14FC6C 80025F0C 080097DA */  j          .L80025F68
/* 14FC70 80025F10 00001021 */   addu      $v0, $zero, $zero
.L80025F14:
/* 14FC74 80025F14 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
/* 14FC78 80025F18 A02211A0 */  sb         $v0, %lo(func_80041130 + 0x70)($at)
.L80025F1C:
...
/* 14FCA0 80025F40 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
/* 14FCA4 80025F44 080097DA */  j          .L80025F68
/* 14FCA8 80025F48 A02011A0 */   sb        $zero, %lo(func_80041130 + 0x70)($at)
glabel .L80025F4C
/* 14FCAC 80025F4C 0C02DB14 */  jal        func_800B6C50
.L80025F50:
/* 14FCB0 80025F50 00002021 */   addu      $a0, $zero, $zero
/* 14FCB4 80025F54 3C018004 */  lui        $at, %hi(func_80041130 + 0x70)
.L80025F58:
/* 14FCB8 80025F58 A02011A0 */  sb         $zero, %lo(func_80041130 + 0x70)($at)
...
.size func_80025F7C, . - func_80025F7C
