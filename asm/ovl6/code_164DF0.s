...
/* 164DF0 8003B090 3C028005 */  lui        $v0, %hi(func_8004AC9C_ovl7 + 0x18)
/* 164DF4 8003B094 9042ACB4 */  lbu        $v0, %lo(func_8004AC9C_ovl7 + 0x18)($v0)
...
/* 164E20 8003B0C0 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x18)
/* 164E24 8003B0C4 A020ACB4 */  sb         $zero, %lo(func_8004AC9C_ovl7 + 0x18)($at)
/* 164E28 8003B0C8 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x14)
.L8003B0CC_ovl7:
/* 164E2C 8003B0CC AC30ACB0 */  sw         $s0, %lo(func_8004AC9C_ovl7 + 0x14)($at)
/* 164E30 8003B0D0 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164E34 8003B0D4 A030ACB5 */  sb         $s0, %lo(func_8004AC9C_ovl7 + 0x19)($at)
/* 164E38 8003B0D8 14400006 */  bnez       $v0, .L8003B0F4_ovl6
/* 164E3C 8003B0DC 24020001 */   addiu     $v0, $zero, 0x1
/* 164E40 8003B0E0 3C028004 */  lui        $v0, %hi(.L800401F0_ovl6)
/* 164E44 8003B0E4 244201F0 */  addiu      $v0, $v0, %lo(.L800401F0_ovl6)
/* 164E48 8003B0E8 3C018005 */  lui        $at, %hi(D_8004C45C_ovl7)
/* 164E4C 8003B0EC AC22C45C */  sw         $v0, %lo(D_8004C45C_ovl7)($at)
glabel func_8003B0F0_ovl3
/* 164E50 8003B0F0 24020001 */  addiu      $v0, $zero, 0x1
.L8003B0F4_ovl6:
/* 164E54 8003B0F4 3C018005 */  lui        $at, %hi(D_8004AAE4_ovl7)
/* 164E58 8003B0F8 AC22AAE4 */  sw         $v0, %lo(D_8004AAE4_ovl7)($at)
...
/* 164E6C 8003B10C 3C018005 */  lui        $at, %hi(D_8004BE50_ovl7)
/* 164E70 8003B110 AC22BE50 */  sw         $v0, %lo(D_8004BE50_ovl7)($at)
/* 164E74 8003B114 0C02A626 */  jal        func_800A9898
/* 164E78 8003B118 2404000A */   addiu     $a0, $zero, 0xA
.L8003B11C_ovl6:
/* 164E7C 8003B11C 3C038005 */  lui        $v1, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164E80 8003B120 8063ACB5 */  lb         $v1, %lo(func_8004AC9C_ovl7 + 0x19)($v1)
...
/* 164ED0 8003B170 3C028005 */  lui        $v0, %hi(func_8004AC9C_ovl7 + 0x14)
/* 164ED4 8003B174 8C42ACB0 */  lw         $v0, %lo(func_8004AC9C_ovl7 + 0x14)($v0)
/* 164ED8 8003B178 24430001 */  addiu      $v1, $v0, 0x1
/* 164EDC 8003B17C 28620003 */  slti       $v0, $v1, 0x3
/* 164EE0 8003B180 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x14)
/* 164EE4 8003B184 AC23ACB0 */  sw         $v1, %lo(func_8004AC9C_ovl7 + 0x14)($at)
.L8003B188_ovl3:
/* 164EE8 8003B188 1040001D */  beqz       $v0, .L8003B200_ovl6
.L8003B18C_ovl5:
/* 164EEC 8003B18C 2402FFFE */   addiu     $v0, $zero, -0x2
/* 164EF0 8003B190 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164EF4 8003B194 0800EC82 */  j          .L8003B208_ovl6
/* 164EF8 8003B198 A023ACB5 */   sb        $v1, %lo(func_8004AC9C_ovl7 + 0x19)($at)
.L8003B19C_ovl6:
/* 164EFC 8003B19C 0C00EB9C */  jal        func_8003AE70_ovl7
/* 164F00 8003B1A0 00000000 */   nop
.L8003B1A4_ovl7:
/* 164F04 8003B1A4 14500018 */  bne        $v0, $s0, .L8003B208_ovl6
/* 164F08 8003B1A8 00000000 */   nop
/* 164F0C 8003B1AC 3C028005 */  lui        $v0, %hi(func_8004AC9C_ovl7 + 0x14)
glabel func_8003B1B0_ovl2
/* 164F10 8003B1B0 8C42ACB0 */  lw         $v0, %lo(func_8004AC9C_ovl7 + 0x14)($v0)
...
.L8003B1D4_ovl5:
/* 164F34 8003B1D4 3C028005 */  lui        $v0, %hi(func_8004AC9C_ovl7 + 0x14)
/* 164F38 8003B1D8 8C42ACB0 */  lw         $v0, %lo(func_8004AC9C_ovl7 + 0x14)($v0)
/* 164F3C 8003B1DC 04400008 */  bltz       $v0, .L8003B200_ovl6
/* 164F40 8003B1E0 24020003 */   addiu     $v0, $zero, 0x3
.L8003B1E4_ovl6:
/* 164F44 8003B1E4 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164F48 8003B1E8 0800EC82 */  j          .L8003B208_ovl6
/* 164F4C 8003B1EC A020ACB5 */   sb        $zero, %lo(func_8004AC9C_ovl7 + 0x19)($at)
.L8003B1F0_ovl6:
...
.L8003B200_ovl6:
/* 164F60 8003B200 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164F64 8003B204 A022ACB5 */  sb         $v0, %lo(func_8004AC9C_ovl7 + 0x19)($at)
.L8003B208_ovl6:
/* 164F68 8003B208 3C028005 */  lui        $v0, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164F6C 8003B20C 8042ACB5 */  lb         $v0, %lo(func_8004AC9C_ovl7 + 0x19)($v0)
/* 164F70 8003B210 04430013 */  bgezl      $v0, .L8003B260_ovl6
/* 164F74 8003B214 00001021 */   addu      $v0, $zero, $zero
.L8003B218_ovl3:
/* 164F78 8003B218 3C048005 */  lui        $a0, %hi(D_8004BE50_ovl7)
/* 164F7C 8003B21C 8C84BE50 */  lw         $a0, %lo(D_8004BE50_ovl7)($a0)
/* 164F80 8003B220 24020001 */  addiu      $v0, $zero, 0x1
/* 164F84 8003B224 3C018005 */  lui        $at, %hi(func_8004AC9C_ovl7 + 0x18)
/* 164F88 8003B228 0C025D58 */  jal        func_80097560
/* 164F8C 8003B22C A022ACB4 */   sb        $v0, %lo(func_8004AC9C_ovl7 + 0x18)($at)
.L8003B230_ovl3:
...
/* 164FA0 8003B240 3C048005 */  lui        $a0, %hi(func_8004AC9C_ovl7 + 0x19)
/* 164FA4 8003B244 8084ACB5 */  lb         $a0, %lo(func_8004AC9C_ovl7 + 0x19)($a0)
