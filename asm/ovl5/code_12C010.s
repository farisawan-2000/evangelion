...
glabel func_8003A210_12C010
/* 12C010 8003A210 3C028005 */  lui        $v0, %hi(D_80051E50_143C50)
/* 12C014 8003A214 90421E50 */  lbu        $v0, %lo(D_80051E50_143C50)($v0)
...
/* 12C028 8003A228 10400047 */  beqz       $v0, .L8003A348
/* 12C02C 8003A22C 00808021 */   addu      $s0, $a0, $zero
/* 12C030 8003A230 0C02A5D2 */  jal        func_800A9748
/* 12C034 8003A234 24040001 */   addiu     $a0, $zero, 1
/* 12C038 8003A238 0C02725C */  jal        func_8009C970
/* 12C03C 8003A23C 00000000 */   nop
/* 12C040 8003A240 3C018006 */  lui        $at, %hi(D_8005C390_14E190)
/* 12C044 8003A244 8C26C390 */  lw         $a2, %lo(D_8005C390_14E190)($at)
/* 12C048 8003A248 8C27C394 */  lw         $a3, -0x3c6c($at)
/* 12C04C 8003A24C 3C01C270 */  lui        $at, 0xc270
/* 12C050 8003A250 44810000 */  mtc1       $at, $f0
/* 12C054 8003A254 3C01C190 */  lui        $at, 0xc190
/* 12C058 8003A258 4481A000 */  mtc1       $at, $f20
/* 12C05C 8003A25C 3C01C3C8 */  lui        $at, 0xc3c8
...
/* 12C0A0 8003A2A0 0C009A78 */  jal        func_800269E0_1187E0
...
/* 12C0CC 8003A2CC 3C014170 */  lui        $at, 0x4170
/* 12C0D0 8003A2D0 44810000 */  mtc1       $at, $f0
/* 12C0D4 8003A2D4 3C014180 */  lui        $at, 0x4180
/* 12C0D8 8003A2D8 44811000 */  mtc1       $at, $f2
/* 12C0DC 8003A2DC 3C01C1C0 */  lui        $at, 0xc1c0
/* 12C0E0 8003A2E0 44812000 */  mtc1       $at, $f4
/* 12C0E4 8003A2E4 3C014130 */  lui        $at, 0x4130
/* 12C0E8 8003A2E8 44813000 */  mtc1       $at, $f6
/* 12C0EC 8003A2EC 3C0140A0 */  lui        $at, 0x40a0
...
/* 12C120 8003A320 0C00E908 */  jal        func_8003A420_12C220
...
/* 12C138 8003A338 0C00A157 */  jal        func_8002855C_11A35C
/* 12C13C 8003A33C 24050008 */   addiu     $a1, $zero, 8
/* 12C140 8003A340 3C018005 */  lui        $at, %hi(D_80051E50_143C50)
/* 12C144 8003A344 A0201E50 */  sb         $zero, %lo(D_80051E50_143C50)($at)
.L8003A348:
/* 12C148 8003A348 16000003 */  bnez       $s0, .L8003A358
/* 12C14C 8003A34C 24020001 */   addiu     $v0, $zero, 1
/* 12C150 8003A350 3C018005 */  lui        $at, %hi(D_80051E54_143C54)
/* 12C154 8003A354 AC221E54 */  sw         $v0, %lo(D_80051E54_143C54)($at)
.L8003A358:
/* 12C158 8003A358 3C028005 */  lui        $v0, %hi(D_80051E54_143C54)
/* 12C15C 8003A35C 8C421E54 */  lw         $v0, %lo(D_80051E54_143C54)($v0)
/* 12C160 8003A360 1440000C */  bnez       $v0, .L8003A394
/* 12C164 8003A364 00000000 */   nop
/* 12C168 8003A368 3C048006 */  lui        $a0, %hi(D_8005DDD0)
/* 12C16C 8003A36C 0C00E949 */  jal        func_8003A524_12C324
/* 12C170 8003A370 8C84DDD0 */   lw        $a0, %lo(D_8005DDD0)($a0)
/* 12C174 8003A374 3C018005 */  lui        $at, %hi(D_80051E54_143C54)
/* 12C178 8003A378 0C009767 */  jal        func_80025D9C_117B9C
/* 12C17C 8003A37C AC221E54 */   sw        $v0, %lo(D_80051E54_143C54)($at)
/* 12C180 8003A380 3C048008 */  lui        $a0, %hi(D_80080750)
/* 12C184 8003A384 0C00A1B0 */  jal        func_800286C0_11A4C0
/* 12C188 8003A388 24840750 */   addiu     $a0, $a0, %lo(D_80080750)
/* 12C18C 8003A38C 0800E903 */  j          .L8003A40C
...
/* 12C1D0 8003A3D0 0C00A16B */  jal        func_800285AC_11A3AC
...
/* 12C1E4 8003A3E4 8C440008 */   lw        $a0, 8($v0)
/* 12C1E8 8003A3E8 3C048006 */  lui        $a0, %hi(D_8005DDD0)
/* 12C1EC 8003A3EC 0C00E95C */  jal        func_8003A570_12C370
/* 12C1F0 8003A3F0 2484DDD0 */   addiu     $a0, $a0, %lo(D_8005DDD0)
/* 12C1F4 8003A3F4 24020001 */  addiu      $v0, $zero, 1
/* 12C1F8 8003A3F8 24030001 */  addiu      $v1, $zero, 1
/* 12C1FC 8003A3FC 3C018005 */  lui        $at, %hi(D_80051E54_143C54)
/* 12C200 8003A400 AC201E54 */  sw         $zero, %lo(D_80051E54_143C54)($at)
/* 12C204 8003A404 3C018005 */  lui        $at, %hi(D_80051E50_143C50)
/* 12C208 8003A408 A0231E50 */  sb         $v1, %lo(D_80051E50_143C50)($at)
.L8003A40C:
...
/* 12C248 8003A448 0C00AEC4 */  jal        func_8002BB10_11D910
/* 12C24C 8003A44C 24110001 */   addiu     $s1, $zero, 1
/* 12C250 8003A450 24030007 */  addiu      $v1, $zero, 7
/* 12C254 8003A454 AE020000 */  sw         $v0, ($s0)
/* 12C258 8003A458 AC43001C */  sw         $v1, 0x1c($v0)
/* 12C25C 8003A45C 2403000F */  addiu      $v1, $zero, 0xf
/* 12C260 8003A460 AC430004 */  sw         $v1, 4($v0)
/* 12C264 8003A464 AC510008 */  sw         $s1, 8($v0)
...
/* 12C278 8003A478 0C00AEC4 */  jal        func_8002BB10_11D910
/* 12C27C 8003A47C AC51000C */   sw        $s1, 0xc($v0)
/* 12C280 8003A480 3C013EB3 */  lui        $at, 0x3eb3
/* 12C284 8003A484 34213333 */  ori        $at, $at, 0x3333
/* 12C288 8003A488 44810000 */  mtc1       $at, $f0
/* 12C28C 8003A48C 24030067 */  addiu      $v1, $zero, 0x67
/* 12C290 8003A490 AE020004 */  sw         $v0, 4($s0)
/* 12C294 8003A494 AC43001C */  sw         $v1, 0x1c($v0)
/* 12C298 8003A498 24030010 */  addiu      $v1, $zero, 0x10
/* 12C29C 8003A49C AC430004 */  sw         $v1, 4($v0)
...
/* 12C2C0 8003A4C0 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 12C2C4 8003A4C4 8E040004 */   lw        $a0, 4($s0)
/* 12C2C8 8003A4C8 8E020004 */  lw         $v0, 4($s0)
...
/* 12C2E8 8003A4E8 24070002 */   addiu     $a3, $zero, 2
/* 12C2EC 8003A4EC AE020008 */  sw         $v0, 8($s0)
/* 12C2F0 8003A4F0 AC400018 */  sw         $zero, 0x18($v0)
/* 12C2F4 8003A4F4 8E030008 */  lw         $v1, 8($s0)
/* 12C2F8 8003A4F8 2402FFFD */  addiu      $v0, $zero, -3
/* 12C2FC 8003A4FC AC620014 */  sw         $v0, 0x14($v1)
/* 12C300 8003A500 8E040008 */  lw         $a0, 8($s0)
/* 12C304 8003A504 02001021 */  addu       $v0, $s0, $zero
/* 12C308 8003A508 24030008 */  addiu      $v1, $zero, 8
...
/* 12C338 8003A538 8E040008 */   lw        $a0, 8($s0)
/* 12C33C 8003A53C 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 12C340 8003A540 8E040000 */   lw        $a0, ($s0)
/* 12C344 8003A544 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 12C348 8003A548 8E040004 */   lw        $a0, 4($s0)
/* 12C34C 8003A54C 0C00AFA5 */  jal        func_8002BE94_11DC94
/* 12C350 8003A550 8E040000 */   lw        $a0, ($s0)
/* 12C354 8003A554 0C00AFA5 */  jal        func_8002BE94_11DC94
/* 12C358 8003A558 8E040004 */   lw        $a0, 4($s0)
...
glabel func_8003A570_12C370
/* 12C370 8003A570 27BDFFE8 */  addiu      $sp, $sp, -0x18
/* 12C374 8003A574 AFB00010 */  sw         $s0, 0x10($sp)
/* 12C378 8003A578 00808021 */  addu       $s0, $a0, $zero
/* 12C37C 8003A57C 1200000D */  beqz       $s0, .L8003A5B4
/* 12C380 8003A580 AFBF0014 */   sw        $ra, 0x14($sp)
/* 12C384 8003A584 8E040000 */  lw         $a0, ($s0)
/* 12C388 8003A588 1080000A */  beqz       $a0, .L8003A5B4
/* 12C38C 8003A58C 00000000 */   nop
/* 12C390 8003A590 0C00AF04 */  jal        func_8002BC10_11DA10
/* 12C394 8003A594 00000000 */   nop
/* 12C398 8003A598 8E040000 */  lw         $a0, ($s0)
/* 12C39C 8003A59C 0C00AF04 */  jal        func_8002BC10_11DA10
/* 12C3A0 8003A5A0 24840004 */   addiu     $a0, $a0, 4
/* 12C3A4 8003A5A4 8E040000 */  lw         $a0, ($s0)
/* 12C3A8 8003A5A8 0C0326A1 */  jal        func_800C9A84
/* 12C3AC 8003A5AC 00000000 */   nop
/* 12C3B0 8003A5B0 AE000000 */  sw         $zero, ($s0)
.L8003A5B4:
