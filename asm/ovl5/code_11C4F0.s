...
/* 11C5A0 8002A7A0 3C0141A0 */  lui        $at, 0x41a0
/* 11C5A4 8002A7A4 44810000 */  mtc1       $at, $f0
/* 11C5A8 8002A7A8 3C01C320 */  lui        $at, 0xc320
...
/* 11C5E8 8002A7E8 0C00AA27 */  jal        func_8002A89C_11C69C
...
/* 11C5F8 8002A7F8 3C018006 */  lui        $at, %hi(D_8005DC50)
/* 11C5FC 8002A7FC AC22DC50 */  sw         $v0, %lo(D_8005DC50)($at)
/* 11C600 8002A800 0C00A157 */  jal        func_8002855C_11A35C
/* 11C604 8002A804 24050002 */   addiu     $a1, $zero, 2
/* 11C608 8002A808 3C018005 */  lui        $at, %hi(D_80051A00_143800)
/* 11C60C 8002A80C A0201A00 */  sb         $zero, %lo(D_80051A00_143800)($at)
.L8002A810:
/* 11C610 8002A810 16000003 */  bnez       $s0, .L8002A820
/* 11C614 8002A814 24020001 */   addiu     $v0, $zero, 1
/* 11C618 8002A818 3C018005 */  lui        $at, %hi(D_80051A04_143804)
/* 11C61C 8002A81C AC221A04 */  sw         $v0, %lo(D_80051A04_143804)($at)
.L8002A820:
/* 11C620 8002A820 3C028005 */  lui        $v0, %hi(D_80051A04_143804)
/* 11C624 8002A824 8C421A04 */  lw         $v0, %lo(D_80051A04_143804)($v0)
/* 11C628 8002A828 1440000C */  bnez       $v0, .L8002A85C
/* 11C62C 8002A82C 00000000 */   nop
/* 11C630 8002A830 3C048006 */  lui        $a0, %hi(D_8005DC50)
/* 11C634 8002A834 0C00AA73 */  jal        func_8002A9CC_11C7CC
/* 11C638 8002A838 8C84DC50 */   lw        $a0, %lo(D_8005DC50)($a0)
/* 11C63C 8002A83C 3C018005 */  lui        $at, %hi(D_80051A04_143804)
/* 11C640 8002A840 0C009767 */  jal        func_80025D9C_117B9C
/* 11C644 8002A844 AC221A04 */   sw        $v0, %lo(D_80051A04_143804)($at)
/* 11C648 8002A848 3C048008 */  lui        $a0, %hi(D_80080750)
/* 11C64C 8002A84C 0C00A1B0 */  jal        func_800286C0_11A4C0
/* 11C650 8002A850 24840750 */   addiu     $a0, $a0, %lo(D_80080750)
/* 11C654 8002A854 0800AA23 */  j          .L8002A88C
/* 11C658 8002A858 00001021 */   addu      $v0, $zero, $zero
.L8002A85C:
/* 11C65C 8002A85C 3C048008 */  lui        $a0, %hi(D_80080750)
/* 11C660 8002A860 0C00A16B */  jal        func_800285AC_11A3AC
/* 11C664 8002A864 24840750 */   addiu     $a0, $a0, %lo(D_80080750)
/* 11C668 8002A868 3C048006 */  lui        $a0, %hi(D_8005DC50)
/* 11C66C 8002A86C 0C00AAA5 */  jal        func_8002AA94_11C894
/* 11C670 8002A870 2484DC50 */   addiu     $a0, $a0, %lo(D_8005DC50)
/* 11C674 8002A874 24020001 */  addiu      $v0, $zero, 1
/* 11C678 8002A878 24030001 */  addiu      $v1, $zero, 1
/* 11C67C 8002A87C 3C018005 */  lui        $at, %hi(D_80051A04_143804)
/* 11C680 8002A880 AC201A04 */  sw         $zero, %lo(D_80051A04_143804)($at)
/* 11C684 8002A884 3C018005 */  lui        $at, %hi(D_80051A00_143800)
/* 11C688 8002A888 A0231A00 */  sb         $v1, %lo(D_80051A00_143800)($at)
.L8002A88C:
...
/* 11C6C8 8002A8C8 3C0142B4 */  lui        $at, 0x42b4
/* 11C6CC 8002A8CC 4481A000 */  mtc1       $at, $f20
/* 11C6D0 8002A8D0 00000000 */  nop
/* 11C6D4 8002A8D4 0C00AEC4 */  jal        func_8002BB10_11D910
/* 11C6D8 8002A8D8 24110007 */   addiu     $s1, $zero, 7
/* 11C6DC 8002A8DC 2403008D */  addiu      $v1, $zero, 0x8d
/* 11C6E0 8002A8E0 AE020000 */  sw         $v0, ($s0)
/* 11C6E4 8002A8E4 AC430004 */  sw         $v1, 4($v0)
/* 11C6E8 8002A8E8 240300AC */  addiu      $v1, $zero, 0xac
/* 11C6EC 8002A8EC AC430008 */  sw         $v1, 8($v0)
/* 11C6F0 8002A8F0 24030001 */  addiu      $v1, $zero, 1
/* 11C6F4 8002A8F4 AC51001C */  sw         $s1, 0x1c($v0)
/* 11C6F8 8002A8F8 AC400044 */  sw         $zero, 0x44($v0)
/* 11C6FC 8002A8FC AC43000C */  sw         $v1, 0xc($v0)
/* 11C700 8002A900 0C00AEC4 */  jal        func_8002BB10_11D910
/* 11C704 8002A904 E4540054 */   swc1      $f20, 0x54($v0)
/* 11C708 8002A908 24030058 */  addiu      $v1, $zero, 0x58
/* 11C70C 8002A90C AE020004 */  sw         $v0, 4($s0)
/* 11C710 8002A910 AC51001C */  sw         $s1, 0x1c($v0)
/* 11C714 8002A914 0C00AEC4 */  jal        func_8002BB10_11D910
/* 11C718 8002A918 AC430004 */   sw        $v1, 4($v0)
/* 11C71C 8002A91C 2403005A */  addiu      $v1, $zero, 0x5a
/* 11C720 8002A920 AE020008 */  sw         $v0, 8($s0)
/* 11C724 8002A924 AC51001C */  sw         $s1, 0x1c($v0)
/* 11C728 8002A928 AC430004 */  sw         $v1, 4($v0)
/* 11C72C 8002A92C 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C730 8002A930 8E040000 */   lw        $a0, ($s0)
/* 11C734 8002A934 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C738 8002A938 8E040004 */   lw        $a0, 4($s0)
/* 11C73C 8002A93C 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C740 8002A940 8E040008 */   lw        $a0, 8($s0)
/* 11C744 8002A944 8E020000 */  lw         $v0, ($s0)
/* 11C748 8002A948 8E030008 */  lw         $v1, 8($s0)
/* 11C74C 8002A94C 8C440034 */  lw         $a0, 0x34($v0)
/* 11C750 8002A950 8C660034 */  lw         $a2, 0x34($v1)
/* 11C754 8002A954 3C058006 */  lui        $a1, %hi(D_8005AA34_14C834)
/* 11C758 8002A958 24A5AA34 */  addiu      $a1, $a1, %lo(D_8005AA34_14C834)
/* 11C75C 8002A95C 0C02864D */  jal        func_800A1934
/* 11C760 8002A960 00A03821 */   addu      $a3, $a1, $zero
/* 11C764 8002A964 0C00AEC4 */  jal        func_8002BB10_11D910
...
/* 11C778 8002A978 AC430004 */  sw         $v1, 4($v0)
/* 11C77C 8002A97C AC400008 */  sw         $zero, 8($v0)
/* 11C780 8002A980 AC400044 */  sw         $zero, 0x44($v0)
/* 11C784 8002A984 0C00AEC4 */  jal        func_8002BB10_11D910
/* 11C788 8002A988 E4540054 */   swc1      $f20, 0x54($v0)
/* 11C78C 8002A98C 3C013F80 */  lui        $at, 0x3f80
...
/* 11C7A8 8002A9A8 AC830004 */  sw         $v1, 4($a0)
/* 11C7AC 8002A9AC AC800008 */  sw         $zero, 8($a0)
...
/* 11C7DC 8002A9DC 8E020000 */  lw         $v0, ($s0)
/* 11C7E0 8002A9E0 8C420038 */  lw         $v0, 0x38($v0)
/* 11C7E4 8002A9E4 8443001E */  lh         $v1, 0x1e($v0)
/* 11C7E8 8002A9E8 240200FF */  addiu      $v0, $zero, 0xff
/* 11C7EC 8002A9EC 50620025 */  beql       $v1, $v0, .L8002AA84
/* 11C7F0 8002A9F0 24020001 */   addiu     $v0, $zero, 1
/* 11C7F4 8002A9F4 3C05C180 */  lui        $a1, 0xc180
...
/* 11C80C 8002AA0C 0C00A18C */  jal        func_80028630_11A430
/* 11C810 8002AA10 00C03821 */   addu      $a3, $a2, $zero
/* 11C814 8002AA14 8E040000 */  lw         $a0, ($s0)
/* 11C818 8002AA18 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C81C 8002AA1C 00000000 */   nop
/* 11C820 8002AA20 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C824 8002AA24 8E04000C */   lw        $a0, 0xc($s0)
/* 11C828 8002AA28 0C00AF3F */  jal        func_8002BCFC_11DAFC
/* 11C82C 8002AA2C 8E040010 */   lw        $a0, 0x10($s0)
/* 11C830 8002AA30 0C00AFA5 */  jal        func_8002BE94_11DC94
/* 11C834 8002AA34 8E040000 */   lw        $a0, ($s0)
/* 11C838 8002AA38 8E03000C */  lw         $v1, 0xc($s0)
/* 11C83C 8002AA3C 24020001 */  addiu      $v0, $zero, 1
/* 11C840 8002AA40 AC62000C */  sw         $v0, 0xc($v1)
/* 11C844 8002AA44 0C00AFA5 */  jal        func_8002BE94_11DC94
/* 11C848 8002AA48 8E04000C */   lw        $a0, 0xc($s0)
/* 11C84C 8002AA4C 8E04000C */  lw         $a0, 0xc($s0)
/* 11C850 8002AA50 8E070010 */  lw         $a3, 0x10($s0)
/* 11C854 8002AA54 3C058006 */  lui        $a1, %hi(D_8005AA3C_14C83C)
/* 11C858 8002AA58 24A5AA3C */  addiu      $a1, $a1, %lo(D_8005AA3C_14C83C)
/* 11C85C 8002AA5C 00003021 */  addu       $a2, $zero, $zero
/* 11C860 8002AA60 0C00B361 */  jal        func_8002CD84_11EB84
/* 11C864 8002AA64 24E70060 */   addiu     $a3, $a3, 0x60
/* 11C868 8002AA68 8E030010 */  lw         $v1, 0x10($s0)
/* 11C86C 8002AA6C 8C620000 */  lw         $v0, ($v1)
/* 11C870 8002AA70 34420001 */  ori        $v0, $v0, 1
/* 11C874 8002AA74 AC620000 */  sw         $v0, ($v1)
/* 11C878 8002AA78 0C00AFA5 */  jal        func_8002BE94_11DC94
...
glabel func_8002AA94_11C894
/* 11C894 8002AA94 27BDFFE8 */  addiu      $sp, $sp, -0x18
/* 11C898 8002AA98 AFB00010 */  sw         $s0, 0x10($sp)
/* 11C89C 8002AA9C 00808021 */  addu       $s0, $a0, $zero
/* 11C8A0 8002AAA0 12000016 */  beqz       $s0, .L8002AAFC
/* 11C8A4 8002AAA4 AFBF0014 */   sw        $ra, 0x14($sp)
/* 11C8A8 8002AAA8 8E040000 */  lw         $a0, ($s0)
/* 11C8AC 8002AAAC 10800013 */  beqz       $a0, .L8002AAFC
/* 11C8B0 8002AAB0 00000000 */   nop
/* 11C8B4 8002AAB4 0C00AF04 */  jal        func_8002BC10_11DA10
/* 11C8B8 8002AAB8 00000000 */   nop
/* 11C8BC 8002AABC 8E040000 */  lw         $a0, ($s0)
/* 11C8C0 8002AAC0 0C00AF04 */  jal        func_8002BC10_11DA10
/* 11C8C4 8002AAC4 24840004 */   addiu     $a0, $a0, 4
/* 11C8C8 8002AAC8 8E040000 */  lw         $a0, ($s0)
/* 11C8CC 8002AACC 0C00AF04 */  jal        func_8002BC10_11DA10
/* 11C8D0 8002AAD0 24840008 */   addiu     $a0, $a0, 8
/* 11C8D4 8002AAD4 8E040000 */  lw         $a0, ($s0)
/* 11C8D8 8002AAD8 0C00AF04 */  jal        func_8002BC10_11DA10
/* 11C8DC 8002AADC 2484000C */   addiu     $a0, $a0, 0xc
/* 11C8E0 8002AAE0 8E040000 */  lw         $a0, ($s0)
/* 11C8E4 8002AAE4 0C00AF04 */  jal        func_8002BC10_11DA10
/* 11C8E8 8002AAE8 24840010 */   addiu     $a0, $a0, 0x10
/* 11C8EC 8002AAEC 8E040000 */  lw         $a0, ($s0)
/* 11C8F0 8002AAF0 0C0326A1 */  jal        func_800C9A84
/* 11C8F4 8002AAF4 00000000 */   nop
/* 11C8F8 8002AAF8 AE000000 */  sw         $zero, ($s0)
.L8002AAFC:
