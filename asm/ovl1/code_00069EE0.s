...
/* 69EE0 80025C00 3C038003 */  lui        $v1, %hi(D_8002EB3C_72E1C)
/* 69EE4 80025C04 9063EB3C */  lbu        $v1, %lo(D_8002EB3C_72E1C)($v1)
...
/* 69EFC 80025C1C 3C018003 */  lui        $at, %hi(jtbl_8002FAF8_73DD8)
/* 69F00 80025C20 00220821 */  addu       $at, $at, $v0
/* 69F04 80025C24 8C22FAF8 */  lw         $v0, %lo(jtbl_8002FAF8_73DD8)($at)
/* 69F08 80025C28 00400008 */  jr         $v0
/* 69F0C 80025C2C 00000000 */   nop
glabel L80025C30_69F10
...
/* 69F34 80025C54 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 69F38 80025C58 A022EB3C */  sb         $v0, %lo(D_8002EB3C_72E1C)($at)
/* 69F3C 80025C5C 08009754 */  j          .L80025D50
/* 69F40 80025C60 00001021 */   addu      $v0, $zero, $zero
glabel L80025C64_69F44
/* 69F44 80025C64 0C027444 */  jal        func_8009D110
/* 69F48 80025C68 00002021 */   addu      $a0, $zero, $zero
/* 69F4C 80025C6C 3C048003 */  lui        $a0, %hi(D_8002EB18_72DF8)
/* 69F50 80025C70 0C027448 */  jal        func_8009D120
/* 69F54 80025C74 2484EB18 */   addiu     $a0, $a0, %lo(D_8002EB18_72DF8)
...
/* 69F68 80025C88 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 69F6C 80025C8C A022EB3C */  sb         $v0, %lo(D_8002EB3C_72E1C)($at)
/* 69F70 80025C90 08009754 */  j          .L80025D50
/* 69F74 80025C94 00001021 */   addu      $v0, $zero, $zero
glabel L80025C98_69F78
/* 69F78 80025C98 3C048003 */  lui        $a0, %hi(D_8002EB18_72DF8)
/* 69F7C 80025C9C 2484EB18 */  addiu      $a0, $a0, %lo(D_8002EB18_72DF8)
...
/* 69FC4 80025CE4 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 69FC8 80025CE8 A022EB3C */  sb         $v0, %lo(D_8002EB3C_72E1C)($at)
...
/* 69FE4 80025D04 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 69FE8 80025D08 A022EB3C */  sb         $v0, %lo(D_8002EB3C_72E1C)($at)
/* 69FEC 80025D0C 08009754 */  j          .L80025D50
/* 69FF0 80025D10 00001021 */   addu      $v0, $zero, $zero
glabel L80025D14_69FF4
...
/* 6A008 80025D28 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 6A00C 80025D2C 08009754 */  j          .L80025D50
/* 6A010 80025D30 A020EB3C */   sb        $zero, %lo(D_8002EB3C_72E1C)($at)
glabel L80025D34_6A014
/* 6A014 80025D34 0C02DB14 */  jal        func_800B6C50
/* 6A018 80025D38 00002021 */   addu      $a0, $zero, $zero
/* 6A01C 80025D3C 3C018003 */  lui        $at, %hi(D_8002EB3C_72E1C)
/* 6A020 80025D40 A020EB3C */  sb         $zero, %lo(D_8002EB3C_72E1C)($at)
