...
/* 6A170 80025E90 3C058003 */  lui        $a1, %hi(D_8002FB10)
/* 6A174 80025E94 24A5FB10 */  addiu      $a1, $a1, %lo(D_8002FB10)
...
/* 6A184 80025EA4 3C168003 */  lui        $s6, %hi(D_8002FB54)
/* 6A188 80025EA8 26D6FB54 */  addiu      $s6, $s6, %lo(D_8002FB54)
/* 6A18C 80025EAC 3C178003 */  lui        $s7, %hi(D_8002FB5C)
/* 6A190 80025EB0 26F7FB5C */  addiu      $s7, $s7, %lo(D_8002FB5C)
/* 6A194 80025EB4 3C1E8003 */  lui        $fp, %hi(D_8002FB64)
/* 6A198 80025EB8 27DEFB64 */  addiu      $fp, $fp, %lo(D_8002FB64)
...
/* 6A1CC 80025EEC 3C058003 */  lui        $a1, %hi(D_8002FB24)
/* 6A1D0 80025EF0 24A5FB24 */  addiu      $a1, $a1, %lo(D_8002FB24)
...
/* 6A204 80025F24 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A208 80025F28 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
...
/* 6A228 80025F48 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A22C 80025F4C 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80025F50:
/* 6A230 80025F50 3C058003 */  lui        $a1, %hi(D_8002FB2C)
/* 6A234 80025F54 24A5FB2C */  addiu      $a1, $a1, %lo(D_8002FB2C)
...
/* 6A268 80025F88 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A26C 80025F8C 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A270 80025F90 30420400 */  andi       $v0, $v0, 0x400
/* 6A274 80025F94 10400003 */  beqz       $v0, .L80025FA4
/* 6A278 80025F98 00000000 */   nop
/* 6A27C 80025F9C 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A280 80025FA0 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80025FA4:
/* 6A284 80025FA4 3C058003 */  lui        $a1, %hi(D_8002FB3C)
/* 6A288 80025FA8 24A5FB3C */  addiu      $a1, $a1, %lo(D_8002FB3C)
...
/* 6A2BC 80025FDC 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A2C0 80025FE0 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A2C4 80025FE4 30420200 */  andi       $v0, $v0, 0x200
/* 6A2C8 80025FE8 10400003 */  beqz       $v0, .L80025FF8
/* 6A2CC 80025FEC 00000000 */   nop
/* 6A2D0 80025FF0 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A2D4 80025FF4 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80025FF8:
/* 6A2D8 80025FF8 3C058003 */  lui        $a1, %hi(D_8002FB44)
/* 6A2DC 80025FFC 24A5FB44 */  addiu      $a1, $a1, %lo(D_8002FB44)
...
/* 6A310 80026030 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A314 80026034 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A318 80026038 30420100 */  andi       $v0, $v0, 0x100
/* 6A31C 8002603C 10400003 */  beqz       $v0, .L8002604C
/* 6A320 80026040 00000000 */   nop
/* 6A324 80026044 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A328 80026048 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L8002604C:
/* 6A32C 8002604C 3C058003 */  lui        $a1, %hi(D_8002FB4C)
/* 6A330 80026050 24A5FB4C */  addiu      $a1, $a1, %lo(D_8002FB4C)
...
/* 6A370 80026090 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A374 80026094 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
...
/* 6A384 800260A4 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A388 800260A8 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L800260AC:
...
/* 6A3C8 800260E8 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A3CC 800260EC 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
...
/* 6A3DC 800260FC 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A3E0 80026100 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80026104:
...
/* 6A420 80026140 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A424 80026144 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A428 80026148 30420008 */  andi       $v0, $v0, 8
/* 6A42C 8002614C 10400003 */  beqz       $v0, .L8002615C
/* 6A430 80026150 27A40010 */   addiu     $a0, $sp, 0x10
/* 6A434 80026154 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A438 80026158 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L8002615C:
...
/* 6A46C 8002618C 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A470 80026190 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A474 80026194 3C058003 */  lui        $a1, %hi(D_8002FB6C)
/* 6A478 80026198 24A5FB6C */  addiu      $a1, $a1, %lo(D_8002FB6C)
/* 6A47C 8002619C 30420004 */  andi       $v0, $v0, 4
/* 6A480 800261A0 10400003 */  beqz       $v0, .L800261B0
/* 6A484 800261A4 00000000 */   nop
/* 6A488 800261A8 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A48C 800261AC 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L800261B0:
...
/* 6A4C0 800261E0 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A4C4 800261E4 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A4C8 800261E8 3C058003 */  lui        $a1, %hi(D_8002FB74)
/* 6A4CC 800261EC 24A5FB74 */  addiu      $a1, $a1, %lo(D_8002FB74)
/* 6A4D0 800261F0 30420002 */  andi       $v0, $v0, 2
/* 6A4D4 800261F4 10400003 */  beqz       $v0, .L80026204
/* 6A4D8 800261F8 00000000 */   nop
/* 6A4DC 800261FC 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A4E0 80026200 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80026204:
...
/* 6A518 80026238 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A51C 8002623C 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A520 80026240 3C058003 */  lui        $a1, %hi(D_8002FB7C)
/* 6A524 80026244 24A5FB7C */  addiu      $a1, $a1, %lo(D_8002FB7C)
/* 6A528 80026248 30420001 */  andi       $v0, $v0, 1
/* 6A52C 8002624C 10400003 */  beqz       $v0, .L8002625C
/* 6A530 80026250 00000000 */   nop
/* 6A534 80026254 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A538 80026258 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L8002625C:
...
/* 6A578 80026298 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A57C 8002629C 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A580 800262A0 3C058003 */  lui        $a1, %hi(D_8002FB84)
/* 6A584 800262A4 24A5FB84 */  addiu      $a1, $a1, %lo(D_8002FB84)
/* 6A588 800262A8 30420020 */  andi       $v0, $v0, 0x20
/* 6A58C 800262AC 10400003 */  beqz       $v0, .L800262BC
/* 6A590 800262B0 00000000 */   nop
/* 6A594 800262B4 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A598 800262B8 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L800262BC:
...
/* 6A5CC 800262EC 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A5D0 800262F0 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A5D4 800262F4 3C058003 */  lui        $a1, %hi(D_8002FB8C)
/* 6A5D8 800262F8 24A5FB8C */  addiu      $a1, $a1, %lo(D_8002FB8C)
/* 6A5DC 800262FC 30420010 */  andi       $v0, $v0, 0x10
/* 6A5E0 80026300 10400003 */  beqz       $v0, .L80026310
/* 6A5E4 80026304 00000000 */   nop
/* 6A5E8 80026308 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A5EC 8002630C 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80026310:
...
/* 6A620 80026340 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A624 80026344 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A628 80026348 3C058003 */  lui        $a1, %hi(D_8002FB94)
/* 6A62C 8002634C 24A5FB94 */  addiu      $a1, $a1, %lo(D_8002FB94)
/* 6A630 80026350 30422000 */  andi       $v0, $v0, 0x2000
/* 6A634 80026354 10400003 */  beqz       $v0, .L80026364
/* 6A638 80026358 00000000 */   nop
/* 6A63C 8002635C 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A640 80026360 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L80026364:
...
/* 6A680 800263A0 3C068003 */  lui        $a2, %hi(D_8002FB38)
/* 6A684 800263A4 24C6FB38 */  addiu      $a2, $a2, %lo(D_8002FB38)
/* 6A688 800263A8 3C058003 */  lui        $a1, %hi(D_8002FB9C)
/* 6A68C 800263AC 24A5FB9C */  addiu      $a1, $a1, %lo(D_8002FB9C)
/* 6A690 800263B0 30421000 */  andi       $v0, $v0, 0x1000
/* 6A694 800263B4 10400003 */  beqz       $v0, .L800263C4
/* 6A698 800263B8 00000000 */   nop
/* 6A69C 800263BC 3C068003 */  lui        $a2, %hi(D_8002FB34)
/* 6A6A0 800263C0 24C6FB34 */  addiu      $a2, $a2, %lo(D_8002FB34)
.L800263C4:
...
/* 6A6E0 80026400 3C058003 */  lui        $a1, %hi(D_8002FBA4)
/* 6A6E4 80026404 24A5FBA4 */  addiu      $a1, $a1, %lo(D_8002FBA4)
...
/* 6A768 80026488 3C058003 */  lui        $a1, %hi(D_8002FBB4)
/* 6A76C 8002648C 24A5FBB4 */  addiu      $a1, $a1, %lo(D_8002FBB4)
...
/* 6A7B0 800264D0 3C058003 */  lui        $a1, %hi(D_8002FBBC)
/* 6A7B4 800264D4 24A5FBBC */  addiu      $a1, $a1, %lo(D_8002FBBC)
.L800264D8:
...
/* 6A7F0 80026510 3C058003 */  lui        $a1, %hi(D_8002FBC4)
/* 6A7F4 80026514 24A5FBC4 */  addiu      $a1, $a1, %lo(D_8002FBC4)
...
/* 6A9D8 800266F8 3C058003 */  lui        $a1, %hi(D_8002FBD4)
/* 6A9DC 800266FC 24A5FBD4 */  addiu      $a1, $a1, %lo(D_8002FBD4)
...
/* 6A9F8 80026718 3C058003 */  lui        $a1, %hi(D_8002FBE4)
/* 6A9FC 8002671C 24A5FBE4 */  addiu      $a1, $a1, %lo(D_8002FBE4)
...
/* 6AC0C 8002692C 3C058003 */  lui        $a1, %hi(D_8002FBFC)
/* 6AC10 80026930 24A5FBFC */  addiu      $a1, $a1, %lo(D_8002FBFC)
...
/* 6ACA4 800269C4 3C058003 */  lui        $a1, %hi(D_8002FC1C)
/* 6ACA8 800269C8 24A5FC1C */  addiu      $a1, $a1, %lo(D_8002FC1C)
...
/* 6ACE4 80026A04 3C058003 */  lui        $a1, %hi(D_8002FC24)
/* 6ACE8 80026A08 24A5FC24 */  addiu      $a1, $a1, %lo(D_8002FC24)
...
/* 6AD58 80026A78 3C058003 */  lui        $a1, %hi(D_8002FC1C)
/* 6AD5C 80026A7C 24A5FC1C */  addiu      $a1, $a1, %lo(D_8002FC1C)
...
/* 6AD98 80026AB8 3C058003 */  lui        $a1, %hi(D_8002FC24)
/* 6AD9C 80026ABC 24A5FC24 */  addiu      $a1, $a1, %lo(D_8002FC24)
