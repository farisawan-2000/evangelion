...
/* 74BB0 80025C00 3C038007 */  lui        $v1, %hi(D_80069C90)
/* 74BB4 80025C04 90639C90 */  lbu        $v1, %lo(D_80069C90)($v1)
...
/* 74BCC 80025C1C 3C018008 */  lui        $at, %hi(D_8007D648)
/* 74BD0 80025C20 00220821 */  addu       $at, $at, $v0
/* 74BD4 80025C24 8C22D648 */  lw         $v0, %lo(D_8007D648)($at)
...
/* 74C0C 80025C5C 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74C10 80025C60 A0229C90 */  sb         $v0, %lo(D_80069C90)($at)
...
/* 74C24 80025C74 3C048007 */  lui        $a0, %hi(D_80069C6C)
/* 74C28 80025C78 24849C6C */  addiu      $a0, $a0, %lo(D_80069C6C)
...
/* 74C50 80025CA0 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74C54 80025CA4 A0229C90 */  sb         $v0, %lo(D_80069C90)($at)
/* 74C58 80025CA8 08009758 */  j          .L80025D60
/* 74C5C 80025CAC 00001021 */   addu      $v0, $zero, $zero
/* 74C60 80025CB0 3C048007 */  lui        $a0, %hi(D_80069C6C)
/* 74C64 80025CB4 24849C6C */  addiu      $a0, $a0, %lo(D_80069C6C)
...
/* 74CAC 80025CFC 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74CB0 80025D00 A0229C90 */  sb         $v0, %lo(D_80069C90)($at)
/* 74CB4 80025D04 08009758 */  j          .L80025D60
/* 74CB8 80025D08 00001021 */   addu      $v0, $zero, $zero
.L80025D0C:
/* 74CBC 80025D0C 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74CC0 80025D10 A0229C90 */  sb         $v0, %lo(D_80069C90)($at)
...
/* 74CE4 80025D34 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74CE8 80025D38 A0209C90 */  sb         $zero, %lo(D_80069C90)($at)
...
/* 74CFC 80025D4C 3C018007 */  lui        $at, %hi(D_80069C90)
/* 74D00 80025D50 A0209C90 */  sb         $zero, %lo(D_80069C90)($at)
