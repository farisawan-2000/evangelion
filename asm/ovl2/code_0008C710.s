...
.L8003D7E8:
/* 8C798 8003D7E8 3C038007 */  lui        $v1, %hi(D_8006AD90)
/* 8C79C 8003D7EC 8463AD90 */  lh         $v1, %lo(D_8006AD90)($v1)
/* 8C7A0 8003D7F0 00031040 */  sll        $v0, $v1, 1
/* 8C7A4 8003D7F4 00431021 */  addu       $v0, $v0, $v1
/* 8C7A8 8003D7F8 00023040 */  sll        $a2, $v0, 1
/* 8C7AC 8003D7FC 3C038007 */  lui        $v1, %hi(D_8006AD30)
/* 8C7B0 8003D800 00661821 */  addu       $v1, $v1, $a2
/* 8C7B4 8003D804 8063AD30 */  lb         $v1, %lo(D_8006AD30)($v1)
...
.L8003D820:
/* 8C7D0 8003D820 3C028007 */  lui        $v0, %hi(D_8006AD32)
/* 8C7D4 8003D824 00461021 */  addu       $v0, $v0, $a2
/* 8C7D8 8003D828 8442AD32 */  lh         $v0, %lo(D_8006AD32)($v0)
/* 8C7DC 8003D82C 3C038008 */  lui        $v1, %hi(D_80084614)
/* 8C7E0 8003D830 8C634614 */  lw         $v1, %lo(D_80084614)($v1)
/* 8C7E4 8003D834 3C048007 */  lui        $a0, %hi(D_8006AD31)
/* 8C7E8 8003D838 00862021 */  addu       $a0, $a0, $a2
/* 8C7EC 8003D83C 9084AD31 */  lbu        $a0, %lo(D_8006AD31)($a0)
/* 8C7F0 8003D840 3C078007 */  lui        $a3, %hi(D_8006AD34)
/* 8C7F4 8003D844 00E63821 */  addu       $a3, $a3, $a2
/* 8C7F8 8003D848 80E7AD34 */  lb         $a3, %lo(D_8006AD34)($a3)
...
/* 8C844 8003D894 3C038007 */  lui        $v1, %hi(D_8006AD90)
/* 8C848 8003D898 8463AD90 */  lh         $v1, %lo(D_8006AD90)($v1)
...
/* 8C860 8003D8B0 3C058007 */  lui        $a1, %hi(D_8006AD30)
/* 8C864 8003D8B4 00A22821 */  addu       $a1, $a1, $v0
/* 8C868 8003D8B8 80A5AD30 */  lb         $a1, %lo(D_8006AD30)($a1)
/* 8C86C 8003D8BC 0C0E4959 */  jal        func_80392564
/* 8C870 8003D8C0 24060001 */   addiu     $a2, $zero, 1
/* 8C874 8003D8C4 3C038007 */  lui        $v1, %hi(D_8006AD90)
/* 8C878 8003D8C8 8463AD90 */  lh         $v1, %lo(D_8006AD90)($v1)
/* 8C87C 8003D8CC 00031040 */  sll        $v0, $v1, 1
/* 8C880 8003D8D0 00431021 */  addu       $v0, $v0, $v1
/* 8C884 8003D8D4 00021040 */  sll        $v0, $v0, 1
/* 8C888 8003D8D8 3C018007 */  lui        $at, %hi(D_8006AD30)
/* 8C88C 8003D8DC 00220821 */  addu       $at, $at, $v0
/* 8C890 8003D8E0 8022AD30 */  lb         $v0, %lo(D_8006AD30)($at)
...
/* 8C8A4 8003D8F4 3C028007 */  lui        $v0, %hi(D_8006AD90)
/* 8C8A8 8003D8F8 9442AD90 */  lhu        $v0, %lo(D_8006AD90)($v0)
/* 8C8AC 8003D8FC 26310004 */  addiu      $s1, $s1, 4
/* 8C8B0 8003D900 24420001 */  addiu      $v0, $v0, 1
/* 8C8B4 8003D904 3C018007 */  lui        $at, %hi(D_8006AD90)
/* 8C8B8 8003D908 A422AD90 */  sh         $v0, %lo(D_8006AD90)($at)
...
/* 8C9C0 8003DA10 3C018007 */  lui        $at, %hi(D_8006AD90)
/* 8C9C4 8003DA14 A420AD90 */  sh         $zero, %lo(D_8006AD90)($at)
...
/* 8CB98 8003DBE8 3C028007 */  lui        $v0, %hi(D_8006AD90)
/* 8CB9C 8003DBEC 8442AD90 */  lh         $v0, %lo(D_8006AD90)($v0)
